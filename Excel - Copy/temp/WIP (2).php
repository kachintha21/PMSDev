...
<div class="CSSTableGenerator" align="center" >
 ...
 <td width="59">Date</td>
	...
	if(isset($_POST['filter']))
	{
	   $sql =mysql_query("SELECT * FROM cm  INNER JOIN daily_plan  ON cm.pjt_no = daily_plan.pjtno AND design=pattern AND item=itemno WHERE $where AND belt !='D'  ORDER BY cm.id,design, item,chit_no  ")or die ("err"); 
	 }
