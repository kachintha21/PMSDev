...
<!--                    <li  class="nav-item  active open"> <a href="plan_qty_data.php" class="nav-link "> <i class="fa fa-gears"></i>  Already Plan Data  </a> </li> 
            ...
            <li>
                ...
                <ul class="sub-menu">  
                    ...
                    <li  class="nav-item  active open"> <a href="qc_approval_ps.php" class="nav-link "> <i class="glyphicon glyphicon-briefcase"></i>  QC approval </a> </li>
...
<                    <li  class="nav-item  active open"> <a href="virtual_planner_beta.php" class="nav-link "> <i class="glyphicon glyphicon-briefcase"></i>  Virtual Planner</a> </li>
            ...
            <li>
                ...
                <ul class="sub-menu">                                                                                                  
                                        ...
                                        <li  class="nav-item  active open"> <a href="dinspection_ps.php" class="nav-link "> <i class="glyphicon glyphicon-briefcase"></i>  Decal Inspection </a> </li> 
