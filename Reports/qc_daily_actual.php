...
//$count_1new=isset($_REQUEST["count_1new"]) ? $_REQUEST["count_1new"] : "";
		...
		for ($x = 1; $x <= $count_1; $x++) {
			...
			header("Location:qc_daily_actual.php?p_date=$plan_date_fix");
	}
	...
	if(isset($_POST['btnprio_4']))
	{
		...
		header("Location:qc_daily_actual.php?p_date=$plan_date");
	}
...
?>
	...
	<?php
		...
		<table width="800" height="5" border="0" align="center">
			<tr align="center">
				<td align="center" style="color:#36a2ef;font-size: -webkit-xxx-large;"><H3>QC Daily Actual</H3></td>
			</tr>
		</table>
		<table width="800" height="5" border="0" align="center">
			<tr>
					...
					<td width="120" >
						<table width="120" height="75" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td colspan="7"  width="120" height="25" align="center" valign="middle" bgcolor="#004848" class="style15">QC Daily Actual </td>
							...
							<tr class="style13">
								...
								<td width="10" height="25" align="left" valign="middle" bgcolor="#004848" class="style15">Pass Qty</td>
							</tr>  
							...
							<tr class="tcday">
								...
								$query_1 =mysqli_query($con,"SELECT * FROM qc_qc_approval_tbl a WHERE a.org_date_qc ='$today'");
								...
								<tr class="style13" <?php if($a_1['reset']=='1'){ ?> bgcolor="#CCFFFF"<?php }?>>
									...
									value="<?php print $a_1['pro_no_qc'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="design<?php print $count_1 ?>"class="input3" id="design<?php print $count_1 ?>"
										
									value="<?php print $a_1['pattern_no_qc'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="lot<?php print $count_1 ?>"class="input3" id="lot<?php print $count_1 ?>"
										
									value="<?php print $a_1['lot_no_qc'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['org_date_qc'];?>" readonly ></td>
									
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['printing_qty_qc'];?>" readonly ></td>
