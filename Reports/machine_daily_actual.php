...
<title>Machine Daily Actual</title>
<?php 
...
//$count_1new=isset($_REQUEST["count_1new"]) ? $_REQUEST["count_1new"] : "";
		...
		for ($x = 1; $x <= $count_1; $x++) {
			...
			header("Location:machine_daily_actual.php?p_date=$plan_date_fix");
	}
	...
	if(isset($_POST['btnprio_4']))
	{
		...
		header("Location:machine_daily_actual.php?p_date=$plan_date");
	}
...
?>
	...
	<?php
		...
		<table width="800" height="5" border="0" align="center">
			<tr align="center">
				<td align="center" style="color:#36a2ef;font-size: -webkit-xxx-large;"><H3>Machine Daily Actual</H3></td>
			</tr>
		</table>
		<table width="800" height="5" border="0" align="center">
			<tr>
					...
					<td width="120" >
						<table width="120" height="75" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td colspan="12"  width="120" height="25" align="center" valign="middle" bgcolor="#004848" class="style15">Machine Daily Actual </td>
							...
							<tr class="tcday">
								...
								$query_1 =mysqli_query($con,"SELECT * FROM virtual_planner_final_tbl a WHERE a.date_vpft ='$today' and a.plan_colors_vpft !='S00'
ORDER BY a.is_edit_vpft desc,a.item01_vpft,a.item02_vpft");
								...
								<tr class="style13" <?php if($a_1['reset']=='1'){ ?> bgcolor="#CCFFFF"<?php }?>>
									...
									value="<?php print $a_1['pro_no_vpft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="design<?php print $count_1 ?>"class="input3" id="design<?php print $count_1 ?>"
										
									value="<?php print $a_1['design_vpft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="lot<?php print $count_1 ?>"class="input3" id="lot<?php print $count_1 ?>"
										
									value="<?php print $a_1['lot_vpft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['date_vpft'];?>" readonly ></td>
									
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['item01_vpft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['item02_vpft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['imp_plan_vpft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['imp_actual_vpft'];?>" readonly ></td>
