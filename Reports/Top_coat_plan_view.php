...
<title>Top Coat Remaning Plan</title>
<?php 
	...
	{
		$plan_date=isset($_REQUEST["trip-start"]) ? $_REQUEST["trip-start"] : "";
		
		
		header("Location:Top_coat_plan_view.php?p_date=$plan_date");
	}
...
<BODY onLoad="startclock()">
	...
	<?php
		...
		<table width="800" height="5" border="0" align="center">
			<tr align="center">
				<td align="center" style="color:#36a2ef;font-size: -webkit-xxx-large;"><H3>Top Coat Remaning Plan</H3></td>
			</tr>
		</table>
		<table width="800" height="5" border="0" align="center">
			<tr>
		...
		<form id="form2" name="form2" method="post">
			...
			<table width="800" height="5" border="0" align="center"><tr>
				...
				<td width="83"><label for="start">Choose a date:</label></td>
				<td width="114"  nowrap><input type="date" id="start" name="trip-start"></td>
					...
					<td width="120" >
						<table width="120" height="75" border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<tr class="style13">
								...
								<td width="10" height="25" align="left" valign="middle" bgcolor="#004848" class="style15">Status</td>
							</tr>  
							...
							<tr class="tcday">
								...
								$query_1 =mysqli_query($con,"SELECT * FROM (SELECT a.*,'late'
FROM tbl_top_coat_plan a 
LEFT JOIN top_coat_printing_tbl b
ON a.pro_no=b.pro_no_tcpt
WHERE b.pro_no_tcpt IS NULL AND a.p_date !='2024-05-24'
...
");
								...
								value="<?php print $a_1['late'];?>" readonly ></td>
