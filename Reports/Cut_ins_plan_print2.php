		...
		<?php
			...
			{	include("database_connections.php");
				...
				$dateTime =  date("Y-m-d h:i:sa");
							...
							$query1 =mysqli_query($con,"select * from tbl_cut_ins_plan a where p_date ='$p_date' and shift = '3' order by ABS(order_no),pro_no");
			...
			<table width="533" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr class="font">
					<td height="20" colspan="7" align="center" bgcolor="#FFFFFF"><a >
						<u><font size="+1"><b>Cutting & Ins Plan 7.30 - 4.30 </br> user - 3 </br>   Plan Date<?php print $p_date; ?> - Print Date -<?php print $dateTime;?></b></font></u> 
					</a></td>
