...
<title>Pigment Daily Actual</title>
<?php 
...
//$count_1new=isset($_REQUEST["count_1new"]) ? $_REQUEST["count_1new"] : "";
		...
		for ($x = 1; $x <= $count_1; $x++) {
			...
			header("Location:Pigment_daily_actual.php?p_date=$plan_date_fix");
	}
	...
	if(isset($_POST['btnprio_4']))
	{
		...
		header("Location:Pigment_daily_actual.php?p_date=$plan_date");
	}
...
<title>:: Noritake - Pigment Daily Actual ::</title>
...
?>
	...
	<?php
		...
		<table width="800" height="5" border="0" align="center">
			<tr align="center">
				<td align="center" style="color:#36a2ef;font-size: -webkit-xxx-large;"><H3>Pigment Daily Actual</H3></td>
			</tr>
		</table>
		<table width="800" height="5" border="0" align="center">
			<tr>
					...
					<td width="120" >
						<table width="120" height="75" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td colspan="12"  width="120" height="25" align="center" valign="middle" bgcolor="#004848" class="style15">Pigment Daily Actual </td>
							...
							<tr class="tcday">
								...
								$query_1 =mysqli_query($con,"SELECT a.* FROM pigment_planner_final_tbl a WHERE   a.date_ppft='$today' 
AND a.is_edit_ppft !='1' ORDER BY a.design_ppft,a.plan_colors_ppft,a.colors_name_ppft ASC");
								...
								<tr class="style13" <?php if($a_1['reset']=='1'){ ?> bgcolor="#CCFFFF"<?php }?>>
									...
									value="<?php print $a_1['pro_no_ppft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="design<?php print $count_1 ?>"class="input3" id="design<?php print $count_1 ?>"
										
									value="<?php print $a_1['design_ppft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="lot<?php print $count_1 ?>"class="input3" id="lot<?php print $count_1 ?>"
										
									value="<?php print $a_1['lot_ppft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['date_ppft'];?>" readonly ></td>
									
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['item01_ppft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['item02_ppft'];?>" readonly ></td>
									
									<td valign="middle" width="48" >
										<input name="qty<?php print $count_1 ?>"class="input3" id="qty<?php print $count_1 ?>"
										
									value="<?php print $a_1['imp_plan_ppft'];?>" readonly ></td>
