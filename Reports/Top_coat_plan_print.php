		...
		<?php
			...
			{	include("database_connections.php");
				...
				//$query1 =mysql_query("SELECT * FROM tbl_barcode_data where cart_no=$cart and status='0' order by chit_no,id desc");	
							...
							$query1 =mysqli_query($con,"SELECT * FROM (SELECT a.*,'late'
FROM tbl_top_coat_plan a 
LEFT JOIN top_coat_printing_tbl b
ON a.pro_no=b.pro_no_tcpt
WHERE b.pro_no_tcpt IS NULL and a.p_date !='$p_date'

UNION 

SELECT *,'New' from tbl_top_coat_plan a where p_date ='$p_date' order by ABS(order_no),pro_no) aa
ORDER BY aa.p_date,aa.order_no");
				
				//$pro1 = mysql_query("update tbl_barcode_data set status='1',transfer_no='$transfer_no' where cart_no=$cart and status='0'")or die("err");
			...
			<table width="533" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr class="font">
					<td height="20" colspan="7" align="center" bgcolor="#FFFFFF"><a >
						<u><font size="+1"><b>Top Coat Plan <?php print $p_date; ?> - Print Date -<?php print $dateTime;?></b></font></u> 
					</a></td>
				...
				<tr class="font">
					...
					<td width="48" height="25" align="left" valign="middle" bgcolor="#004848" class="style15">Plan Date</td>
