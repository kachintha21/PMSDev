...
//$count_1new=isset($_REQUEST["count_1new"]) ? $_REQUEST["count_1new"] : "";
		...
		for ($x = 1; $x <= $count_1; $x++) {
			...
			header("Location:Top_coat_plan.php?p_date=$plan_date_fix");
	}
	...
	if(isset($_POST['btnprio_4']))
	{
		...
		header("Location:Top_coat_plan.php?p_date=$plan_date");
	}
...
?>
	...
	<?php
		...
		<table width="800" height="5" border="0" align="center">
			<tr align="center">
				<td align="center" style="color:#36a2ef;font-size: -webkit-xxx-large;">Top Coat Plan</td>
			</tr>
		</table>
		<table width="800" height="5" border="0" align="center">
			<tr>
					...
					<td width="120" >
						<table width="120" height="75" border="0" align="center" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td colspan="6"  width="120" height="25" align="center" valign="middle" bgcolor="#004848" class="style15">QC Approved Jobs</td>
							...
							<tr class="tcday">
								...
								$query_1 =mysqli_query($con,"SELECT * FROM (SELECT * FROM (SELECT a.*,b.actual_qty_qc from printing_status_tbl a
LEFT JOIN qc_approval_tbl b
ON a.ref_no_pst=b.pro_no_qc
WHERE a.pro06_pst='1'  GROUP BY production_no_pst ) aa
WHERE aa.ref_no_pst NOT IN (SELECT aa.pro_no FROM (SELECT a.*,'late'
FROM tbl_top_coat_plan a 
LEFT JOIN top_coat_printing_tbl b
ON a.pro_no=b.pro_no_tcpt
WHERE b.pro_no_tcpt IS NULL and a.p_date !='$today'

UNION 

SELECT *,'New' from tbl_top_coat_plan a where p_date ='$today' order by ABS(order_no),pro_no) aa
ORDER BY aa.p_date,aa.order_no)) aa WHERE aa.org_date_pst > '2024-05-01' ");
								...
								<tr class="style13" <?php if($a_1['reset']=='1'){ ?> bgcolor="#CCFFFF"<?php }?>>
									...
									value="<?php print $a_1['actual_qty_qc'];?>" readonly ></td>
				...
				<td width="400" >
					<table width="400" height="100" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td colspan="10"  width="300" height="25" align="center" valign="middle" bgcolor="#004848" class="style15">Planned Jobs</td>
						...
						<tr class="tcday">
							...
							<td><input name="btnchange" value="Change ALL" class="button button2"  type="submit" src="search.jpg" width="60" height="20"    /></td>
							</tr> <?php 
							include("database_connections.php");
							//print("select * from tbl_top_coat_plan a where p_date ='$today' order by order_no");exit;
							$query_2 =mysqli_query($con,"SELECT * FROM (SELECT a.*,'late'
FROM tbl_top_coat_plan a 
LEFT JOIN top_coat_printing_tbl b
ON a.pro_no=b.pro_no_tcpt
WHERE b.pro_no_tcpt IS NULL and a.p_date !='$today' GROUP BY a.pro_no
...
");
					...
					$teac2_tt=0;
						...
						$tea=$s_time;
							...
							?>
							<tr class="style13" <?php if($a_2['late']=='late'){ ?> bgcolor="#FFCCCB"<?php }?>>
					...
					<tr>
					<td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
					<td><input name="btnfin" value="Finalize Plan" class="button button2"  type="submit" src="search.jpg" width="60" height="20"    /></td>
