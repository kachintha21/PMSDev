...
<title>Top-Coat Plan vs Actual</title>
<?php 
...
//$count_1new=isset($_REQUEST["count_1new"]) ? $_REQUEST["count_1new"] : "";
		...
		for ($x = 1; $x <= $count_1; $x++) {
			...
			header("Location:Top_coat_plan_vs_act.php?p_date=$plan_date_fix");
	}
	...
	if(isset($_POST['btnprio_4']))
	{
		...
		header("Location:Top_coat_plan_vs_act.php?p_date=$plan_date");
	}
...
?>
	...
	<?php
		...
		<table width="800" height="5" border="0" align="center">
			<tr align="center">
				<td align="center" style="color:#36a2ef;font-size: -webkit-xxx-large;">Top-Coat Plan vs Actual</td>
			</tr>
		</table>
		<table width="800" height="5" border="0" align="center">
			<tr>
					...
					<td width="800" >
						<table width="800" height="75" border="0" align="center" cellpadding="0" cellspacing="0">
							...
							<td width="10" height="25" align="left" valign="middle" bgcolor="#004848" class="style15">No</td>
								...
								<td width="50" height="25" align="left" valign="middle" bgcolor="#004848" class="style15">Actual Qty</td>
							...
							<tr class="tcday">
								...
								$query_1 =mysqli_query($con,"SELECT * FROM tbl_top_coat_plan a 
