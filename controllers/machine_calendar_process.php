...
$lt = new MachineCalendar(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
...
if (count($_POST) > 0) {
    ...
    if ($error != "") {
        ...
        $res = $lt->createNewMachineCalendar(
                $_POST['id'], $_POST['date_mlt'], $_POST['machine_no_mlt'], $_POST['number_shift_mlt'], $work_time_mlt,0, $_POST['item01_mlt'], $_POST['item02_mlt'], $_POST['item03_mlt'], $_POST['item04_mlt'], $_POST['item05_mlt'], $_POST['org_name_mlt'], getServerDate(), getServerTime()
        );
