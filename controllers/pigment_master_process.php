...
if (count($_POST) > 0) {
    ...
    if (empty($_POST['id'])) {
        ...
        $res = $pm->createNewPigmentModel(
                $_POST['id'], $_POST['ref_no_pm'], $_POST['pattern_pm'], $_POST['paper_size_pm'], $_POST['st_proof_pape_pm'], $_POST['printing_way_pm'], $_POST['body_pm'], $_POST['decoration_pm'], $_POST['market_pm'], $_POST['layout_pm'], 0, $sheets, $_POST['item02_pmt'], $_POST['item03_pmt'], $_POST['item04_pmt'], $_POST['item05_pmt'], $_POST['org_name_pmt'], getServerDate(), getServerTime()
        );
