...
if (count($_POST) > 0) {
    ...
    if ($error != "") {
        ...
        $query = "SELECT COUNT(lot_no_pcdt) As T,design_pcdt,lot_no_pcdt,first_color_print_pcdt, curves_pcdt,qty_pcdt,pro_no_pcdt           
                FROM past_curves_details_tbl WHERE  design_pcdt='" . $_POST['design_pt'] . "'  AND  (curves_pcdt='" . $_POST['curve01'] . "'  OR  curves_pcdt='" . $_POST['curve02']. "'  OR   curves_pcdt='" . $_POST['curve03']. "'   OR  curves_pcdt='" . $_POST['curve04']. "'   OR  curves_pcdt='" . $_POST['curve05']. "'   OR  curves_pcdt='" . $_POST['curve06']. "'    OR  curves_pcdt='" . $_POST['curve07']. "'    OR  curves_pcdt='" . $_POST['curve08']. "'    OR  curves_pcdt='" . $_POST['curve09']. "'   OR  curves_pcdt='" . $_POST['curve10']. "'              
                ) group by  `lot_no_pcdt` ORDER BY T DESC";
      ...
      <td><?php echo($ma['first_color_print_pcdt']); ?></td>
                    <td><?php 
                     ...
                     $sql = "SELECT curves_pcdt,qty_pcdt             
                           
                              FROM past_curves_details_tbl WHERE  design_pcdt='" . $ma['design_pcdt'] . "' AND lot_no_pcdt='".$ma['lot_no_pcdt']."'  AND pro_no_pcdt='".$ma['pro_no_pcdt']."'  ";
