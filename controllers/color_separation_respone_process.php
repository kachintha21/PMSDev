...
if (count($_POST) > 0) {
    ...
    if ($error != "") {
        ...
        $pro_no_sc=$_POST['pro_no_sc'];
        $lot_no_sc=$_POST['lot_no_sc'];
        $ref=$pro_no_sc."-".$lot_no_sc;
        

        //$rest = $pl->getPreparingLayoutByLotNo($_POST['pro_no_sc'], $_POST['lot_no_sc'], $session_pattern_no);
