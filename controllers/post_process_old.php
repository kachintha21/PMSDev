...
?>
                               ...
                               <div>Time Duration:<b><?php echo ($getdate01." To ".$getdate02);    ?></b>
								...
								<table class="table table-striped table-bordered table-hover"  id="checkbox-table">
						 ...
						 <td rowspan="2" style="font-size:12px; padding:4px;">Total</td>	
						  ...
						  <?php
                                        ...
                                        ?>
											     ...
											     <td style="text-align:left; font-size:11px; padding:4px; word-wrap:break-word; width:10%;"  class="total_<?php echo($row["id"]);?>" >
									 ...
									 <td style="font-size:12px; padding:4px;" colspan="4" class="<?php echo("K".$rowat["id"]);?>_<?php echo($row["id"]); ?>"  ><?php 									 
					

									  echo("K".$rowat["id"]."_".$row["id"]);
