...
if (count($_POST) > 0) {
 ...
 $qc_shheet=3;
        ...
        foreach ($_POST['desing_no_lpt'] as $key => $id) {
            ...
            $res2 = $lp->updateLayoutplans(
                    $_POST['id'][$key], $_POST['pro_no_lpt'], $_POST['layout'], $_POST['status'], $_POST['desing_no_lpt'][$key], $_POST['curve_no_lpt'][$key], $_POST['decal_no_lpt'][$key], $_POST['planned_qty_lpt'][$key], $_POST['no_of_curves_lpt'][$key], $_POST['no_of_sheets_lpt'][$key], $_POST['close_curve_after_lpt'][$key], $_POST['total_sheets_needed_lpt'][$key], 1, $_POST['status_lpt'], $_POST['item01_lpt'], $_POST['item02_lpt'], $_POST['item03_lpt'], $_POST['item04_lpt'], $_POST['item05_lpt'], $_POST['org_name_lpt'], getServerDate(), getServerTime()
            );
        }
