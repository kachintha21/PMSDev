...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Process View</title>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'process.php';">
                                                       Process View<i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
  ...
  <th>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
        <?php echo($row["process_name_pt"]); ?> 
                                                        </td>


                                                    <td>
        <?php echo($row["is_edit_pt"]); ?> 
                                                        </td>
        ...
        <?php echo($row["org_date_pt"]); ?> 
                                                        </td>


                                                        <td>

        <?php echo($row["org_time_pt"]); ?> 
                                                        </td>
                                                        
                                                        
                                                        
                                                  <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'process.php';">
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'process.php?ID=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>
                          ...
                          onclick="deleteEntity('<?php echo($row['id']);?>','process.php?id=<?php echo($row['id']);?>',
			'<?php echo($row['id']);  ?>')"; 
			 ></span></td>
