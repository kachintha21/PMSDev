...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Section View</title>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'section.php';">
                                                        Section View <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
      ...
      <th>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
        <?php echo($row["section_name_st"]); ?> 
                                                        </td>


                                                    
                                                        <td>
        <?php echo($row["is_edit_st"]); ?> 
                                                        </td>
        ...
        <?php echo($row["org_time_st"]); ?> 
                                       ...
                                       <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'section.php';">
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'section.php?ID=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"   onclick="deleteEntity('<?php echo($row['id']); ?>', 'section.php?id=<?php echo($row['id']); ?>','<?php echo($row['id']); ?>')">
                                                            </span></td>
