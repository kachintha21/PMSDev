...
if (isset($_GET['id'])) {
    $co->deleteChangeOverTime($_GET['id']);
    header("location:change_over_time_view.php");
    exit();
}
if (isset($_GET['ID'])) {
    $data = $co->getChangeOverTimeById($_GET['ID']);
}
?>
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake |Change Over Time 
</title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="change_over_time_view.php"> View

                                </a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <a href="#">Change Over Time 
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Change Over Time </div>
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_cott" id="org_name_cott"  value="<?php echo($loge_user); ?>" />
                                        ...
                                        <input  type="hidden" class="form-control"  name="is_edit_cott" id="is_edit_cott" value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[3] + 1);
                                        }
                                                ?>" />
                                        ...
                                        <div class="form-body">                    
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-sm-4">
                                                    <input  type="text" class="form-control" name="machine_no_cott" id="machine_no_cott" 
                                                            value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[2]);
                                        }
                                                ?>"  />                         
                                                   ...
                                                   <label class="control-label col-sm-2">Time <span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-4">
                                                    <input  type="number" class="form-control" name="time_cott" id="time_cott" 
                                                            value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[1]);
                                        }
...
<script src="../ajax_post/change_over_time_post.js"></script>
