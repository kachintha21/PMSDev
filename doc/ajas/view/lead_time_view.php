                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    ...
                                                    Lead Time<i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
...
Date
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM lead_time_tbl ORDER BY id DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["pattern_no_ltt"]); ?> 
                                                        </td>


                                                                                                  <td>

                                                            <?php echo($row["is_edi_ltt"]); ?> 
                                                        </td>
                                                      

                                                        <td>      
                                                            <?php echo($row["org_date_llt"]); ?> 
                                                        </td>                

                                                        <td>      
                                                            <?php echo($row["org_time_llt"]); ?> 
                                                        </td>  
                                                        
                                                        
                                                                  <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'lead_time.php';">
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'lead_time.php?ID=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>
                                                        
                                                          <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'lead_time.php?id=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>

<!--                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'lead_time.php?id=<?php echo($row['id']); ?>',
                                                                                  '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>-->
