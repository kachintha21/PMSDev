...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Defect Details </title>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'defect.php';">
                                                    Defect Details<i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
...
Date
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM defect_tbl ORDER BY id DESC";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php echo($row["defect_name_dt"]); ?> 
                                                        </td>


    <td>
                                                            <?php echo($row["is_edit_dt"]); ?> 
                                                        </td>
                                                        ...
                                                        <td>
                                                          ...
                                                          <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'defect.php';">
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'defect.php?ID=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'defect.php?id=<?php echo($row['id']); ?>',
                                                                                  '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
