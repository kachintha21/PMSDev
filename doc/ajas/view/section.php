...
if (isset($_GET['ID'])) {
    $data = $se->getSectionById($_GET['ID']);
}
?>
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake |New Section</title>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>New Section</div>
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="ref_no_st" id="ref_no_st" 
                                                value="<?php if ($_GET['ID']) { echo($data[1]);
                                                } else {
                                                    echo($se->getNextSectionRefNo("section_tbl", "NLPLSE"));
                                                }
                                                ?>"      
                                        ...
                                        <input  type="hidden" class="form-control"  name="is_edit_st" id="is_edit_st" value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[3] + 1);
                                        }
                                                ?>" />
                                        ...
                                        <div class="form-body">                    
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-sm-4">
                                                    <input  type="text" class="form-control" name="section_name_st" id="section_name_st" 
                                                            value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[2]);
                                        }
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        ...
                                                        if ($_GET['ID']) {
                                                            ?>
                                                            <button type="button" class="btn purple" onClick="return submit_section_edit();" > <i class="fa fa-check"></i> save changes </button>
                                                        <?php } else { ?>
