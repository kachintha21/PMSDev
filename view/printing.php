...
$pt = new Printing(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
...
<html lang="en">
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
        ...
        <div class="page-container">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="printing_view.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> <i class="fa fa-angle-right"></i> </li>



                            <li> <a href="#"  style="text-decoration: none" title="WIP" ><b>WIP(<?php echo($pt->getWipPrinting()); ?>)</b></a>                       <i class="fa fa-angle-right"></i> </li>





                            <li> <a href="#"  style="text-decoration: none" title="Daily_Output" ><b>Daily_Output(<?php echo($pt->getDailyOutPutQtyPrinting(getServerDate())); ?>)</b></a>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Printing
                                    </div>
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="pattern_no_pt" id="pattern_no_pt"  value="<?php echo($preparing[4]); ?>" readonly/>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="pro_no_pt" id="pro_no_pt"  value="<?php echo($session_pattern_no); ?>" readonly/>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="lot_no_pt" id="lot_no_pt"  value="<?php echo($preparing[3]); ?>" readonly/>
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="number" class="form-control" name="item01_pt" id="item01_pt"  value="<?php echo($preparing[15]); ?>"  readonly/>
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="colours_index_pt" id="colours_index_pt"  value="<?php echo($clr); ?>" readonly/>

                                                </div> 

                                                <label class="control-label col-sm-2"> 	Printing Machine<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">

                                                    <select class="form-control"    name='machine_no_pt' id='machine_no_pt'>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <select class="form-control"    name='judgment_pt' id='judgment_pt'>
            ...
            <script src="../ajax_post/printing_post.js
            "></script>
