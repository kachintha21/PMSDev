...
if (isset($_GET['id'])) {
   $lt->deleteLeadTimeById($_GET['id']);
     header("lead_time_view.php");
   // exit();
}
if (isset($_GET['ID'])) {
    $data = $lt->getLeadTimeById($_GET['ID']);
}
?>
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Lead Time</title>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="lead_time_view.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> 
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Lead Time
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_llt" id="org_name_llt"  value="<?php echo($loge_user); ?>" />
     <input  type="hidden" class="form-control"  name="id" id="id"        value="<?php
        ...
        <input  type="hidden" class="form-control"  name="id" id="id"        value="<?php
                                        ...
                                        <input  type="hidden" class="form-control"  name="is_edi_ltt" id="is_edi_ltt" value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[4] + 1);
                                        }
                                                ?>" />
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                               ...
                                               <?php
                                                 if ($_GET['ID']) {?>
                                                    <input  type="text" class="form-control" name="design_ltt" id="design_ltt"    value="<?php       echo($data[1]);?>"/>
                                               ...
                                               <?php 
                                                ...
                                                <label class="control-label col-sm-2">Process Name <span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">
                                                   <?php
                                                 if ($_GET['ID']) {?>
                                                      <input  type="text" class="form-control" name="pro_name_ltt" id="pro_name_ltt"    value="<?php echo($data[2]);?>"/>
                                                       <?php 
                                                 }
                                            else {
                                                ?>
                                                   <select  class="form-control" name="pro_name_ltt" id="pro_name_ltt">
                                                        <option value="Pigment preparation ">Pigment preparation </option>
                                                        <option value="Layout Film outing">Layout Film outing</option>
                                                ...
                                                <label class="control-label col-sm-2">Lead Time
                                                    <span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">


                                                    <input  type="number" class="form-control" name="pattern_no_ltt" id="pattern_no_ltt"     value="<?php echo($data[3]);?>"/>
                                            ...
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                     <?php
                                                        if ($_GET['ID']) {
                                                            ?>
                                                    <button type="button" class="btn purple" onClick="return submit_save();" > <i class="fa fa-check"></i> Save changes </button>
                                                        <?php } else { ?>
            ...
            <script src="../ajax_post/lead_time_post.js"></script>
