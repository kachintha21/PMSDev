...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake| Layout Registration  </title>
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button type="button" class="btn purple" onClick="return form_ps();" > <i class="fa fa-check"></i> Decal </button>
														  <button type="button" class="btn purple" onClick="return form_ps2();" > <i class="fa fa-check"></i> BS </button>
