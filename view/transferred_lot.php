...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Report[Transferred Lots]</title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Report[Transferred Lots] </a>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT SUM(item01_dt) as item01_dt,SUM(remain_qty_dt) as remain_qty_dt,lot_no_dt,curve_no_dt  FROM dinspection_tbl WHERE judgment_dt='1' GROUP BY curve_no_dt  ORDER BY id DESC";
                                            ?>  
