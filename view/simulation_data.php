...
<head>
<meta charset="utf-8"/>
<title>Noritake|Simulation Data</title>
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<button  class="btn green" onclick="window.location='planning_data.php';">
											 New Simulation <i class="fa fa-plus"></i>
											</button>
										</div>
									</div>
									<div class="col-md-6">
							...
							<tbody>
                                                          ...
                                                          <?php
                                                          $query = "SELECT MIN(waste_per_sheet_st) AS waste_per_sheet_st,item01_st,"
                                                                  . "ref_no_st,curve_no_st,desing_no_st,qty_st,aera_st,sheet_per_curve_st,number_of_sheet_st,total_waste_st FROM simulation_result_tbl  ORDER BY id DESC";
							...
							<tr>
                                                                               ...
                                                                               <td>
								<?php echo($row["item01_st"]);?> 
								</td>
                                                            
                                                             <td>
								<?php echo($row["ref_no_st"]);?> 
								</td>
						                 
                                                                <td>
								<?php echo($row["curve_no_st"]);?> 
								</td>
                                                                
                                                                
                                        
								<td>
								<?php echo($row["desing_no_st"]);?> 
								</td>
								...
								<td>
									<?php echo($row["sheet_per_curve_st"]);?>
								</td>
                                                                
                                                                <td>
									<?php echo($row["number_of_sheet_st"]);?>
								</td>
                                                                
                                                                
                                                                
                                                                       <td>
									<?php echo($row["waste_per_sheet_st"]);?>
								</td>
                                                                
                                                                          <td>
									<?php echo($row["total_waste_st"]);?>
								</td>
