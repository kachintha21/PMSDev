...
if (isset($_GET['id'])) {
    $qc->deleteProcess($_GET['id']);
    header("location:qc_approval_view.php");
    exit();
}
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Printing Approval</title>
...
Date
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM qc_approval_tbl ORDER BY id DESC";
                                            ?>  
...
<?php StylesColor($row["reject_items_qc"]); ?> 
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'qc_approval_view.php?id=<?php echo($row['id']); ?>',
                                                                                  '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
