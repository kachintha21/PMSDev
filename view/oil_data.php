...
$id = $_GET['id'];
$res = $pm->getPigmentMasterByPrintingId($id);
?>
<!DOCTYPE html>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Oil Details</title>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'mixing_master.php';">
                                                        New Oil   <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM oil_data_tbl  WHERE pattern_no_odt='" . $res[1] . "' AND  colours_code_odt='" . $res[2] . "'   ORDER BY colours_code_odt DESC";
                                            ?>  
        ...
        <?php echo($row["colours_code_odt"]); ?> 
                                                        ...
                                                        <td>									
        <?php echo($row["oil_name_odt"]); ?> 
                                                        </td>
                                                        <td>									
        <?php echo($row["oil_qty_odt"]); ?> 
                                                        </td>
        ...
        if ($row["is_edit_odt"] == "") {
            ...
            echo($row["is_edit_odt"]);
        }
        ?>
                                                        </td>

                                                        <td>
        <?php echo($row["org_date_odt"]); ?>
                                                        </td>


                                                        <td>
        <?php echo($row["org_time_odt"]); ?>
                                                        </td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            ...
                                                            <a href="oil_edit.php?id=<?php echo($row['id']); ?>">Edit</a>
