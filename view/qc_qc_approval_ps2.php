                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="qc_qc_approval_view.php"> View

                                </a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                                            <li> <a href="#"  style="text-decoration: none" title="WIP" >WIP(<?php echo($qc->getWipQcApproval()); ?>)</a>                       <i class="fa fa-angle-right"></i> </li>





                            <li> <a href="#"  style="text-decoration: none" title="Daily_Output" >Daily_Output(<?php echo($qc->getDailyOutPutQtyQcApproval(getServerDate())); ?>)</a>
                        </ul>
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <div class="form-body">            
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <select  class="form-control" name="pro_no_qc"  id="pro_no_qc">

                                                    <?php
                                                       $Status->getPrintingStatusNew(8);
                                                        ?>
