                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="decal_inspection_view.php"> View
                            ...
                            <li> <a href="#"  style="text-decoration: none" title="Daily_Output" >Daily_Output(<?php echo($did->getDailyOutPutQtyDecalInspection(getServerDate())); ?>)</a>
                        </ul>
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <div class="form-body">            
                                            <div class="form-group form-group">
                                                <label class="control-label col-sm-3">Production No<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">
                                                    <select  class="form-control" name="pro_no_dt"  id="pro_no_dt">

                                                    <?php
                                                       $Status->getPrintingStatus("54",7);
                                                        ?>
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button type="button" class="btn purple" onClick="return  form_pp();" > <i class="fa fa-check"></i> Select </button>
