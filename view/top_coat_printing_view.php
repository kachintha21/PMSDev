                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'top_coat_printing_ps.php';">
                                                    Top Coat Process<i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
...
Date
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM top_coat_printing_tbl ORDER BY id DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["lot_no_tcpt"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["colours_index_tcpt"]); ?> 
                                                        </td>

                                                        <td>

<?php echo($row["machine_no_tcpt"]); ?> 
</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["judgment_tcpt"]); ?> 
                                                        </td>
														
														<td>      
                                                            <?php echo($row["item01_tcpt"]); ?> 
                                                        </td> 
    
                                                        <td>      
                                                            <?php echo($row["org_date_tcpt"]); ?> 
                                                        </td>                

                                                        <td>      
                                                            <?php echo($row["org_time_tcpt"]); ?> 
                                                        </td>  
