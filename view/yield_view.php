...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Yield Master Data</title>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM yield_master_tbl  ORDER BY  id DESC LIMIT 1000";
                                            ?> 
                                            <?php
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php echo($row["fg_design_no_ymt"]); ?> 
                                                        </td>

                                                        <td>

                                                            <?php echo($row["curve_no_ymt"]); ?> 
                                                        </td>

                                                        <td>
                                                            <?php echo($row["decal_design_no_ymt"]); ?>
                                                        </td>


                                                        <td>
                                                            <?php echo($row["yield_value_ymt"]); ?>
                                                        </td>
                                                        
                                                        
                                                             <td>
                                                            <?php echo($row["is_edit_ymt"]); ?>
                                                        </td>


                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'yield.php';">
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'yield.php?ID=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"   onclick="deleteEntity('<?php echo($row['id']); ?>', 'yield.php?id=<?php echo($row['id']); ?>','<?php echo($row['id']); ?>')">
                                                            </span></td>
                                                         </tr>
