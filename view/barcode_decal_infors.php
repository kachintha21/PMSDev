...
$query_se = "SELECT item02_dt FROM dinspection_tbl ORDER BY id DESC LIMIT 1";

if ($result_se = $conn->query($query_se)) {
    while ($rowt_se = $result_se->fetch_assoc()) {
        $id = $rowt_se["item02_dt"];
    }
}
