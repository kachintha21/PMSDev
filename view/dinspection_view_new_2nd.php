...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake| Inspection  Data With 2nd </title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="dinspection_ps_new_2nd.php">Inspection Data With 2nd </a>
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'dinspection_ps_new_2nd.php';">
                                                        Inspection Data With 2nd <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM tbl_cut_ins_plan_ins_data_with_2nd a ORDER BY a.id desc";
                                            ?>  
