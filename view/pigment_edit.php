...
include("../model/Pigment.class.php");

$drn = new Pigment(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
$color = $drn->getPigmentMasterByPrintingId($_GET['id']);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Pigment Edit</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <h3 class="page-title">Pigment Edit
                        <small></small>
                    </h3>
                    <div class="page-bar">
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Pigment Edit
                                    </div>
                                        ...
                                        <div class="form-body"> 
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text"      class="form-control" name="pattern_no_ct" id="pattern_no_ct"  value="<?php echo($color[1]); ?>"
                                                            readonly/>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text"      class="form-control" name="colours_code_ct" id="colours_code_ct"  value="<?php echo($color[2]); ?>" readonly/>
                                                </div> 
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text"      class="form-control" name="colours_name_ct" id="colours_name_ct"  value="<?php echo($color[3]); ?>" readonly/>
                                                </div> 
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text"      class="form-control" name="pigmnet_mesh" id="pigmnet_mesh"  value="<?php echo($color[4]); ?>" />
                                                </div> 
...
<script src="../ajax_post/pigment_post.js"></script>
