...
<div class="page-container">
   ...
   <?php
             ...
             $arr =array(707.56,349.68,406.9,3.5);
             $qty =array(671,672,500,1624);
             $t=max($arr);            
             $total=2310;                     
             $remain=$total-$t*3;                          
              echo($remain);
    ...
    ?> 
                ...
                <div class="row">
                  <div class="col-md-offset-3 col-md-9">
                    <button type="button" class="btn purple" onClick="return form_submit();" > <i class="fa fa-check"></i> Simulation </button>
