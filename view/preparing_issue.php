        ...
        <div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="printing_order_details.php"> View

</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
                                            <a href="#">|Decal Details Registration
 </a>
					</li>
				</ul>
       ...
       <!-- BEGIN FORM-->
              ...
              <input  type="hidden" class="form-control"  name="ref_no_plt" id="ref_no_plt"  value="<?php echo($pl->getNextPreparingLayoutRefNo("planning_details_tbl", "NLPL"));?>" />
                    ...
                    <div class="form-body">                   
                            ...
                            <div class="col-sm-2">
                                <input  type="text" class="form-control" name="lot_no_plt" id="lot_no_plt"  />                         
                           </div> 

                               <label class="control-label col-sm-2">Pattern No<span style="color: crimson;"> *</span></label>
                            <div class="col-sm-2">
                                <input  type="text" class="form-control" name="pattern_no_plt" id="pattern_no_plt"  />                         
                           </div>                                                       
                         ...
                         <div class="form-group form-group">
                            ...
                            <div class="col-sm-2">
                                <input  type="text" class="form-control" name="printing_way_plt" id="printing_way_plt"  />                         
                           </div>    

                              <label class="control-label col-sm-2">Paper Size<span style="color: crimson;"> *</span></label>
                            <div class="col-sm-2">
                                <input  type="text" class="form-control" name="paper_size_plt" id="paper_size_plt"  />                         
                           </div> 

                               <label class="control-label col-sm-2">Body<span style="color: crimson;"> *</span></label>
                            <div class="col-sm-2">
                                <input  type="text" class="form-control" name="body_plt" id="body_plt"  />                         
                           </div>                                                       
                         ...
                         <div class="form-group form-group">
                            ...
                            <div class="col-sm-2">
                                <input  type="text" class="form-control" name="market_plt" id="market_plt"  />                         
                           </div> 

                               <label class="control-label col-sm-2">Decoration<span style="color: crimson;"> *</span></label>
                            <div class="col-sm-2">
                                <input  type="text" class="form-control" name="decoration_plt" id="decoration_plt"  />                         
                           </div>                                                       
                    ...
                    <table class="table table-bordered table-hover" id="tab_logic">
                        ...
                        <tr id='addr0'>
                            ...
                            <td>
                                ...
                                <input type="number" name='decol_pattern_no_pdt[]' id='decol_pattern_no_pdt[]' placeholder='Decol Pattern' class="form-control qty"
                                       step="0" min="0"/>
                            </td>
                      
                           <td><input type="text" name='curve_no_pdt[]' id='curve_no_pdt[]' placeholder='Curve No'  type="text"  class="form-control name" /></td>
                            
                           <td><input type="number" name='plan_pcs_pdt[]' id='plan_pcs_pdt[]' placeholder='Plan PCS' class="form-control qty"
                                       step="0" min="0"/></td>
                                       
                                       
                                       
                           <td><input type="number" name='pcs_per_sheet_pdt[]' id="pcs_per_sheet_pdt[]" placeholder='Pcs per Sheet'
                                       class="form-control price" />
                            </td>
                            <td><input type="number" name='actual_pdt[]' id="actual_pdt[]" placeholder='0.00' class="form-control"
                                       /></td>
                        </tr>
                        <tr id='addr1'></tr>
                        </tbody>
                    ...
                    <table class="table table-bordered table-hover" id="tab_logicp">
                        ...
                        <tr id='addrp0'>
                            ...
                            <select  class="form-control" name="color_ptt[]" id="color_ptt[]">
                                   ...
                                   <?php
                                                          $query = "SELECT * FROM pigment_master_tbl  ORDER BY colours_pm  ASC";
...
<script src="../js/Pigments_layout.js"></script>
