                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <button onclick="exportTableToExcel('sample_editable_1')">Export To Excel </button>
                            <li>
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group pull-right">
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                        ...
                                                        <li>
                                                            <a href="javascript:;" onclick="exportTableToExcel('sample_editable_1')">
                                                                Export to Excel </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                    ...
                                    <table  class="table table-striped table-hover table-bordered" id="sample_editable_1" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th>    
                                                    ...
                                                    Actual <br/>inspected<br/> qty
                                                </th> 
                                                
                                                
                                                <th>    
													Decal<br/> Stores In <br/>qty
                                                </th> 
                                                <th>    
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "select * from (select *,(case when (aa.t is null) then aa.plan_n else aa.plan_n- aa.t - aa.def  end) AS `rem2` from (SELECT *, 
...
where aaa.rem2>0   AND (ccc.item02_qc != 'Rejected' || ccc.item02_qc IS null)
ORDER BY `aaa`.`def`  DESC";
                                            ?>  
...
<td>
														...
														<input type="hidden" id="id" name="id" value="<?php echo($row["id"]) ?>">
                                                                        ...
                                                                        <select name="hre" id="hre" class="form-control product">
                                                                           <option value="Lot rejected by QC">Lot rejected by QC</option>
<option value="Curves rejected by QC">Curves rejected by QC</option>
<option value="Defects curves">Defects curves</option>
<option value="Close curves">Close curves</option>
<option value="Data entering error">Data entering error</option>
<option value="Partial print">Partial print</option>
<option value="Planning Qty error">Planning Qty error</option>
<option value="Order Qty changed">Order Qty changed</option>
<option value="Layout errors">Layout errors</option>
