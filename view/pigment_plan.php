                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="design_number_pidt" id="design_number_pidt"  value="<?php echo(getServerDate()); ?>"  /> 
                                                        ...
                                                        <table class="table table-bordered table-hover" id="tab_logic">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center" width="10%">Changeover
                                                                    ...
                                                                    <th class="text-center" width="10%">Lot No

                                                                    </th>

                                                                    <th class="text-center" width="10%">#Sheet
                                                                    ...
                                                                    <th class="text-center" width="5%">Color Index</th>
                                                               


                                                                    <th class="text-center" width="10%">Color Name </th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <?php
                                                                $query = "SELECT * FROM pigment_plan_tbl WHERE item05_ppt='".$_GET['id']."' AND status_ppt='0'  ORDER BY id DESC";
                                                                ?>  
                                                                ...
                                                                if ($result = $conn->query($query)) {
                                                                    ...
                                                                    while ($row = $result->fetch_assoc()) {
                                                                        ...
                                                                        <tr id='addr0' class="tr-row">
                                                                            ...
                                                                            <td><button type="button" class="btn purple"  onClick="parent.location = '../controllers/pigment_plan_process.php?id=<?php echo($row["id"]); ?>'"   > <i ></i> Save </button></td>
                                                                        </tr>
                                                    ...
                                                    <div class="col-md-12">
                                                        <table class="table table-bordered table-hover" id="tab_logic">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <?php
                                                                $query = "SELECT * FROM pigment_plan_tbl WHERE item05_ppt='".$_GET['id']."' AND status_ppt='1' ORDER BY id ASC";
                                                                ?>  
