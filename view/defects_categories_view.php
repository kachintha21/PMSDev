...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Defects Report</title>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM dinspection_tbl ORDER BY id DESC";
                                            ?>  
       ...
       <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["register_dt"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["line_dt"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["pinhole_dt"]); ?> 
                                                        </td>

                                                        <td>

                                                            <?php echo($row["emboss_dt"]); ?> 
                                                        </td>
                                                        <td>

                                                            <?php echo($row["topcoat_dt"]); ?> 
                                                        </td>

                                                        <td>

                                                            <?php echo($row["dust_dt"]); ?> 
                                                        </td>

                                                        <td>

                                                            <?php echo($row["other_dt"]); ?> 
                                                        </td>

                                                        <td>

                                                            <?php echo($row["color_dt"]); ?> 
                                                        </td>

                                                        <td>

                                                            <?php echo($row["pinhole_repair_dt"]); ?> 
                                                        </td>
                                                        ...
                                                        <td>      
                                                            <?php echo($row["topcoat_repair_dt"]); ?> 
                                                        </td>   
                                                        
                                                          <td>      
                                                            <?php echo($row["topcoat_repair_dt"]+$row["pinhole_repair_dt"]+$row["color_dt"]+$row["other_dt"]+$row["dust_dt"]+$row["dust_dt"]+$row["topcoat_dt"]+$row["emboss_dt"]+$row["pinhole_dt"]+$row["register_dt"]+$row["line_dt"]); ?> 
                                                        </td>  

                                                        <td>      
                                                            <?php echo($row["org_date_dt"]); ?> 
                                                        </td>  

                                                        <td>      
                                                            <?php echo($row["org_time_dt"]); ?> 
                                                        </td>  
