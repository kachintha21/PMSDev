...
<html lang="en">
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'colours_master.php';">
                                                        New Color<i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM colours_tbl WHERE pattern_no_ct='" . $res[1] . "' AND  colours_code_ct='" . $res[2] . "'   ORDER BY colours_name_ct DESC";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
        <?php echo($row["pattern_no_ct"]); ?> 
                                                        </td>

                                                        <td>
        <?php echo($row["colours_code_ct"]); ?> 
                                                        </td>

                                                        <td>									
        <?php echo($row["colours_name_ct"]); ?> 
                                                        </td>
        ...
        ?>
                                                        ...
                                                        <td>
        <?php echo($row["org_date_ct"]); ?>
                                                        </td>


                                                        <td>
        <?php echo($row["org_time_ct"]); ?>
                                                        </td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            ...
                                                            <a href="color_edit.php?id=<?php echo($row['id']); ?>">Edit</a>
