...
$pigmentpreparation = new PigmentPreparation(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Pigment preparation</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Pigment preparation
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="pigment_preparation_view.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> <i class="fa fa-angle-right"></i> </li>



                            <li> <a href="#"  style="text-decoration: none" title="Daily_Output" ><b>WIP(<?php echo($pigmentpreparation->getWipPigmentPreparation()); ?>)</b></a>                     

                                <i class="fa fa-angle-right"></i></li>



                            <li> <a href="#"  style="text-decoration: none" title="Daily_Output" ><b>Daily_Output(<?php echo($pigmentpreparation->getDailyPigmentPreparation(getServerDate())); ?>)</b></a> <i ></i> </li>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Pigment preparation
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_pp" id="org_name_pp"  value="<?php echo($loge_user); ?>" />
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="pattern_no_pp" id="pattern_no_pp"  value="<?php echo($preparing[4]); ?>" />
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="pro_no_pp" id="pro_no_pp"  value="<?php echo($session_pattern_no); ?>" />
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="lot_no_pp" id="lot_no_pp"  value="<?php echo($preparing[3]); ?>" />
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="printing_qty_pp" id="printing_qty_pp"  value="<?php echo($preparing[15]); ?>" />
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <select class="form-control"    name='colour_index' id='colour_index' 

                                                            onchange="return form_ajax();"
                                                            >

                                                        <?php
                                                        $Status->getPrintingStatusColourIndexById($session_pattern_no, 1);
                                                        ?>
                                                ...
                                                <label class="control-label col-sm-2"> 	Pigment  Contents(g) <span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">


                                                    <input  type="number" class="form-control" name="pigment_contents_pp" id="pigment_contents_pp"  />
            ...
            <script src="../ajax_post/pigment_preparation_post.js
            "></script>
            ...
            <script src="../ajax_post/josn_pp.js"></script>
