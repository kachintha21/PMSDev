...
if($_GET['Type'] =='save'){
	...
	$vpf->createNewVPFinal($ref_no_vpft,$vp_data[2]);
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <table style="width:100%">
                                            <tr>
                                                ...
                                                <td style="width:5%"><b><?php echo($m_no); ?></b></td>
                                        ...
                                        <table style="width:100%">
											...
											//print("SELECT*FROM virtual_planner_final_tbl_excel Where plan_date='2022-09-01' and M_no='".$m_no."' ");
                                $query = "SELECT*FROM virtual_planner_final_tbl_excel Where plan_date='".$vp_data[2]."' and M_no='".$m_no."' ";
								$count=0;
                                if ($result = $conn->query($query)) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>    
                                            ...
                                            <td><?php echo($row['No_of_colour']); ?></td>
											<td><?php echo($row['Qty']); ?></td>
											<td><?php ?></td>
											<td><?php echo($row['remark']); ?></td>
                                            <td><?php echo($row['Plan_colour']); ?></td>
											<td><?php echo($row['close']); ?></td>
                                            <td><?php echo($row['Time_t']); ?></td>
											 <td><?php echo($row['Change_over']); ?></td>
											  <td><?php echo($row['Plan_print']); ?></td>
											  <td><?php ?></td>
											  <td><?php ?></td>
											  <td><?php ?></td>
											  <td><?php ?></td>
...
if (empty($_GET['ID'])) {
    ?>
                                    <a class="btn btn-lg blue hidden-print margin-bottom-5"                   onclick="PlanSaveConfirm('<?php echo($_GET['id']); ?>', 'virtual_printing_planne_view.php?id=<?php echo($_GET['id']); ?>&ID=<?php echo ('save'); ?>&Type=save',
                                                        '<?php echo($_GET['id']); ?>')";  >
                                        Save MM Plan
                                    </a>
