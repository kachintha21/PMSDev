...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Color Separation</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Color Separation
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="color_separation_view.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> <i class="fa fa-circle"></i> </li>

                            <li> <a href="index.php"  style="text-decoration: none" title="Daily_Output" ><b>WIP(<?php echo($cs->getWipColorSeparation($session_pattern_no)); ?>)


                                    </b></a> <i class="fa fa-circle"></i> </li>
                            <li> <a href="index.php"  style="text-decoration: none" title="WIP" ><b>Daily_Output(<?php echo($cs->getDailyOutPutQtyColorSeparation(getServerDate(), $session_pattern_no)); ?>)</b></a> <i class="fa fa-circle"></i> </li>


                            <li> <b>
                                    <a  href="#"   style="text-decoration: none" title="Changed Pattern No"
                                        onClick="return Changed_pattern('',
                                                        'color_separation_ps.php',
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Color Separation
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_sc" id="org_name_sc"  value="<?php echo($loge_user); ?>" />
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="pattern_no_sc" id="pattern_no_sc"  value="<?php echo($session_pattern_no); ?>" />
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <select class="form-control"    name='pro_no_sc' id='pro_no_sc' onchange="return  ajax();" >

                                                        <?php
                                                        $pt->printProductStatusBy($session_pattern_no, 2, "")
                                                        ?>
                                                ...
                                                <div class="col-sm-2">
                                                    <select  class="form-control  col-sm-2" id="lot_no_sc" name="lot_no_sc" onchange="return form_ajax();"  >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <select class="form-control select2"   id="judgment_sc" name="judgment_sc" >
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea rows="5" cols="50" class="form-control" name="item01_sc" id="item01_sc">-</textarea>
            ...
            <script src="../ajax_post/josn_cs.js"></script>
            <script src="../ajax_post/color_separation_post.js
            "></script>
