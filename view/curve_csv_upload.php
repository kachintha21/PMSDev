...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake |Curve CSV Upload</title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="curve_view.php"> View

                                </a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <a href="#">Curve CSV Upload
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Curve CSV Upload</div>
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                  <form class="form-horizontal" action="curve_csv_upload_process.php" method="post"  enctype="multipart/form-data">
