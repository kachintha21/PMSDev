                            ...
                            <div class="col-xs-12">
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        </td>     <td><?php  echo date("H:i", strtotime($shift_start_time));   ?></td>   <td>N/A
                                            N/A
                                        </td>   <td>
                                            N/A
                                    ...
                                    <tr>
                                        <td>#
                                            ...
                                            <?php                echo($time_fp); //echo date("H:i", strtotime($time_fp));?>
...
<!--                                              <?php // if (strtotime("2000-01-0$dayCount 17:59:00") >= strtotime($getTime)) { ?>                                                 -->
                                                ...
                                                <td><?php echo($row['ship_scheduled_date_vpt']); ?>
                                                </td> 
                                                <td><?php echo($row['pro_no_vpt']); ?></td>
                                                <td><?php echo($row['item01_vpt']); ?></td>
                                                <td  style="<?php if ($status > 0) { echo 'background-color: Blue;'; } ?>" ><?php
                                                            echo($row['lot_no_vpt']); ?></td>
                                                <td><?php echo( $pigm->getNumberPigmentMasterByNo($row['item01_vpt'])); ?></td>  
                                                <td style="<?php
                                                if ($sheetBreak > 1200) {
                                                ...
                                                <td><?php echo($total_time); ?>
                                                <td><?php echo($changeOver); ?></td>
                                                <td><?php echo($time_speed); ?></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                                                <td></td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-8 invoice-block">
                                ...
                                if ($status == 0) {
                                    ?>
                                    <a class="btn btn-lg blue hidden-print margin-bottom-5"                   onclick="PlanSaveConfirm('<?php echo($_GET['id']); ?>', 'save_virtual_printing_planner.php?id=<?php echo($_GET['id']); ?>',
                                                    '<?php echo($_GET['id']); ?>')";  >
                                        Save Plan <i class="fa fa-check">
                                           ...
                                           <?php } else { ?>
                                            <a class="btn btn-lg blue hidden-print margin-bottom-5"                   onclick="PlanResetConfirm('<?php echo($_GET['id']); ?>', 'delete_virtual_printing_planner.php?id=<?php echo($_GET['id']); ?>',
                                                            '<?php echo($_GET['id']); ?>')";  >
                                                Reset Plan <i class="fa fa-check">                                             
