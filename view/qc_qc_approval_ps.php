                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM (SELECT ref_no_pst as pro_no_qc,pattern_no_pst,lot_no_pst FROM printing_status_tbl 
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <a href="qc_qc_approval.php?pro=<?php echo($row["pro_no_qc"])?>">
