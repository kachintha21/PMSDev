...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Simulation Amend </title>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="printable_data.php">Simulation Amend </a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    ...
                                                    Simulation Amend  <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                      ...
                                      Design No
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM saved_layout_plans_tbl WHERE status='0' GROUP BY layout ";
                                            ?>  
        ...
        <?php echo($row["design"]); ?> 
                                                        ...
                                                        <td>
        <?php echo($row["total_sheets_needed"]); ?>
                                                        </td> 
