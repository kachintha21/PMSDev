	...
	error_reporting(0);
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            for ($i = 0; $i < $num_rows; $i++) {
                ...
                //print("INSERT INTO screen_planner_final_tbl (design_spft, pro_no_spft, lot_spft,plan_colors_spft,mesh_type_spft,machine_no_spft,date_spft,is_edit_spft,imp_plan_spft,imp_actual_spft) VALUES ('$design_value', '$pro_no_value', '$lot_value','$plan_colors_value', '$plan_value', '$mc_no_value', '$date_value','1', $total_sheets_value,$actual_value)");exit;
                 $sql = "INSERT INTO screen_planner_final_tbl (design_spft, pro_no_spft, lot_spft,plan_colors_spft,mesh_type_spft,machine_no_spft,date_spft,is_edit_spft,imp_plan_spft,imp_actual_spft,change_over_spft,time_spft,item01_spft,item02_spft) VALUES ('$design_value', '$pro_no_value', '$lot_value','$plan_colors_value', '$plan_value', '$mc_no_value', '$date_value','1', '$total_sheets_value','$actual_value','$change_over_value','$time_value','$currentDate','$currentTime')";
