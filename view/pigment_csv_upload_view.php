                ...
                <div class="page-content">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn blue">Pigment CSV Upload</button>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="printable_data.php">Pigment CSV Upload</a>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'pigment_csv_upload.php'">
                                                       Pigment CSV Upload  <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
   ...
   <th>
                  ...
                  <th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM pigment_csv_tbl  GROUP BY IMIEBN  LIMIT 100 ";
                                            ?>  
