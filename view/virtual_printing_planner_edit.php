                            ...
                            <div class="col-xs-12">
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:10%"><b><?php echo('M01'); ?></b></td>
                                        <td style="width:10%">Dryer capacity</td>

                                        <td style="width:10%"><b><?php echo('1200'); ?></b></td>
                                    </tr>
...
//$first_ptime=AddPlayTime($shift_start_time, $prepare_time);
                                ...
                                <table style="width:100%">
                                    ...
                                    <?php
                                    $query_cu = "SELECT SUM(qty_vpt) AS t 
...
WHERE virtual_planner_details_tbl.ref_no_vpt='" . $_GET['id'] . "' AND pigment_master_tbl.colours_pm='S01'
ORDER BY pigment_master_tbl.colours_pm ASC";
                                    ...
                                    ?>am
                                            <?php
                                            if ($result_cu = $conn->query($query_cu)) {
                                                $index = 0;
                                                //print_r($result);
                                                // print_r($result->fetch_array());
                                                $sheetBreak = 0;
                                                $prevColor = '';
                                                while ($row = $result_cu->fetch_assoc()) {
                                        ...
                                        </td> <td>     N/A</td><td>M/P Time</td><td> N/A/<td><td> N/A
                                        </td><td>N/A</td><td>N/A</td><td><?php
                                            echo($prepare_time);
                                            ?>
...
?>
                                        ...
                                        </td> <td>     N/A</td><td>P/P</td><td> N/A/<td>
                                        <td> 
<?php
if ($result_cu = $conn->query($query_cu)) {
    $index = 0;
...
if ($result = $conn->query($query)) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if ($s == 1 AND $index == 1) {
            ...
            $total_time = $change_over + $time_speed;
            echo AddPlayTime($o, $first_pp);
            $perviues = addPlayTime($o, $first_pp);
        } else {
            //echo AddPlayTime($perviues, $total_time);   
        ...
        ?>am                                      
                                        ...
                                        ?></td>
                                                <td><?php
                                        $time_speed = $ps->getPrintingSpeedMasterByColorIndex($row['item01_vpt'], $row['colours_pm'], $row['qty_vpt']);
                                        $total_time = $time_speed + $change_over;
