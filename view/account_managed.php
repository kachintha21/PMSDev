...
$sk = new Skill(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
$pro = new Process(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Account managed</div>
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_st" id="org_name_st"  value="<?php echo($loge_user); ?>" />
                                        ...
                                        <div class="form-body">                    
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-sm-4">
                                                    <input  type="text" class="form-control" name="emp_no_st" id="emp_no_st" 
...
<?php ?>
                                                                <tr id='addrp0'>
                                                                    <td>1</td>
                                                                    <td>
                                                                        <select  class="form-control" name="pro_name_st[]" id="pro_name_st[]">

                                                                <?php
                                                                $pro->getProcessByName();
                                                                ?>
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="button" class="btn purple" onClick="return submit_account();" > <i class="fa fa-check"></i> Save </button>
...
<script src="../js/account_managed.js"></script>
