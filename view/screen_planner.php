                            ...
                            <div class="col-xs-12">
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td> Pro:No</td><td>Design</td><td>Lot</td>
                                        <td>Total sheets</td>
                                        <td>
                                            #
                                            colors
                                    ...
                                    <?php
                                    $query = "SELECT * FROM printing_dynamic_status_tbl WHERE production_no_pdst!='N/A'
                                        ...
                                        <td>
                                            ...
                                            if ($resc = $conn->query($res)) {
                                                while ($rowsc = $resc->fetch_assoc()) {
                                                    ...
                                                    echo($rowsc['pigment_name_ct'] . "-" . $rowsc['qty_ct'] . " Required  " . $Required . "<br>");
                                                }
                                            }
                                            ?>
                                        </td>
