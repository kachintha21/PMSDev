...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Inspection WIP </title>
                                    ...
                                    <table  class="table table-striped table-hover table-bordered" id="sample_editable_1" >
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    Top-Coat <br/>Actual<br/>qty
                                                </th>
												<th>
                                                    Inpection Plan<br/>qty
                                                </th>
                                                <th>    
                                                    Inspection Complete<br/>qty
                                                </th>   
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT a.pro_no,a.design,a.lot,b.item01_tcpt AS top_act,SUM(a.qty) AS ins_plan,c.inscom_qty FROM tbl_cut_ins_planner_wise_data a 
LEFT JOIN top_coat_printing_tbl b
ON a.pro_no =b.pro_no_tcpt
LEFT JOIN (SELECT c.pro_no,SUM(c.qty) AS inscom_qty FROM tbl_cut_ins_plan_ins_data c GROUP BY c.pro_no) c
ON a.pro_no = c.pro_no GROUP BY a.pro_no";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["top_act"]); ?> 
                                                        </td>
														
														<td>

                                                            <?php echo($row["ins_plan"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["inscom_qty"]); ?> 
                                                        </td>
