...
if (isset($_GET['ID'])) {
    $data = $pr->getProcessById($_GET['ID']);
}
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake |New Process</title>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>New Process</div>
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="ref_no_pt" id="ref_no_pt"  
                                                     value="<?php if ($_GET['ID']) { echo($data[1]);
                                                } else {
                                                    echo($pr->getNextProcessRefNo("process_tbl", "NLPLPN"));
                                                }
                                                ?>"    
                                                />
...
<input  type="hidden" class="form-control"  name="id" id="id"       value="<?php
                                        ...
                                        <div class="form-body">                    
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-sm-4">
                                                    <input  type="text" class="form-control" name="process_name_pt" id="process_name_pt" 
                                                           value="<?php
                                                if ($_GET['ID']) {
                                                    echo($data[2]);
                                                }?>"  />                         
       ...
       <input  type="hidden" class="form-control"  name="is_edit_pt" id="is_edit_pt" value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[3] + 1);
                                        }?>"
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        ...
                                                        if ($_GET['ID']) {
                                                            ?>
                                                        <button type="button" class="btn purple" onClick="return submit_process();" > <i class="fa fa-check"></i> save changes </button>
                                                          <?php } else { ?>
                                                        
                                                          <button type="button" class="btn purple" onClick="return submit_process();" > <i class="fa fa-check"></i> Save </button>
                                                          <?php } ?>
...
<script src="../ajax_post/process_post.js"></script>
