...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Printing Plan </title>
...
?>
     ...
     <th>
                                                 Printing start plan date
                                                </th>
                                                
     <th>
                                                Printing start actual date
                                                </th>
                                                
                                                
                                                 <th>
                                                Original due delivery date
                                                </th>
...
?>  
            ...
            <?php echo(""); ?> 
                                                            ...
                                                            <td>
                                                                <?php 
                                                                  $top=$dis->NumberTopCoatgetSheetByNo($row["pattern_no_plt"]);
                                                                echo($ti->getNumberPigmentMasterByNo($row["pattern_no_plt"])-$top); 
