...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Printing Approval View</title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="qc_approval_view.php"> View
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'qc_approval_ps.php';">
                                                        Printing Approval <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT pro_no_lpt as production_no_pst,desing_no_lpt AS pattern_no_pst,lot_no_lpt AS lot_no_pst FROM 
...
AND b.item01_vpft !='' AND b.item01_vpft >= DATE_SUB(NOW(), INTERVAL 100 DAY) AND b.status_vpft !='3' AND
IF(SUBSTRING(b.plan_colors_vpft, 1, 2) = 'S0',
     CAST(SUBSTRING(b.plan_colors_vpft, 2) AS UNSIGNED), -- Remove 'S' and leading 0 if 'S0' is found
     CAST(REPLACE(b.plan_colors_vpft, 'S', '') AS UNSIGNED) -- Otherwise, remove 'S'
  ) = b.num_colors_vpft)
group BY aaa.pro_no_lpt ORDER BY `aaa`.`pro_no_lpt` ";
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <a href="qc_approval.php?pro=<?php echo($row["production_no_pst"])?>">
        <?php echo($row["production_no_pst"]); ?> 
        ...
        <?php echo($row["pattern_no_pst"]); ?> 
                                                        </td>


                                                        <td>

        <?php echo($row["lot_no_pst"]); ?> 
                                                        </td>
