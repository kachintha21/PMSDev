        ...
        <div class="page-container">
            ...
            ?>"/>
                                                    ...
                                                    <thead style="background-color: lightgray; text-align:center;">
                                                        <tr>
                                                            ...
                                                            <td rowspan="2" style="font-size:12px; padding:4px;">Curve</td>
                                                               <td rowspan="2" style="font-size:12px; padding:4px;">Aera</td>
                                                        ...
                                                        <tr id="<?php echo($row["id"]); ?>">
                                                            ...
                                                            <td style="text-align:left; font-size:11px; padding:4px; word-wrap:break-word; width:10%;"><?php echo($row["dec_curve"]); ?></td>
                                                              <td style="text-align:left; font-size:11px; padding:4px; word-wrap:break-word; width:10%;">
                                                                  <?php 
                                                                  $aera=$cm->getCurveAreaByDecal($row["dec_patt"],$row["dec_curve"]);
                                                                  if($aera!=="-"){
                                                                   echo($aera);
                                                                      
                                                                  }else{
                                                                      $newid=$row["dec_patt"]."-".$row["dec_curve"]; 
                                                                      echo("-");
                                                                     // echo("<a href='curve.php?newid=$newid'><p style='color:red; text-decoration:none; target='_blank'         '>Plaese update curve area.</p><a>");
                                                                      // echo("<a href='curve.php?newid=$newid'><p style='color:red; text-decoration:none; target='_blank'         '>Plaese update curve area.</p><a>");
                                                                  }
                                        ...
                                        <div class="col-md-offset-3 col-md-9">
                                            <button type="button" class="btn purple" onClick="return form_submit_automated();"  > <i class="fa fa-check"></i> Submit </button>
