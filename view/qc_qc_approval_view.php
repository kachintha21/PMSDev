...
if (isset($_GET['id'])) {
   ...
   $qc->deleteProcess($_GET['id'],$_GET['pro']);
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'qc_qc_approval_ps.php';">
                                                    QC Approval<i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
...
Date
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM qc_qc_approval_tbl ORDER BY id DESC";
                                            ?>  
...
<td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["printing_qty_qc"]); ?> 
                                                        </td>


  
                                                        <td>      
                                                            <?php echo($row["actual_qty_qc"]); ?> 
                                                        </td> 

                                                    
                                                        <td>

<?php StylesColor($row["reject_items_qc"]); ?> 
</td>
    <td>

                                                            <?php echo($row["item03_qc"]); ?> 
                                                        </td>
														
														
														<td>

                                                            <?php echo($row["org_name_qc"]); ?> 
                                                        </td>

                                                        <td>      
                                                            <?php echo($row["org_date_qc"]); ?> 
                                                        ...
                                                        <td>      
                                                            <?php echo($row["org_time_qc"]); ?> 

                                                        </td> 
                                                        
                                                         <td> 
                                                         <?php
                                                         if($row["reject_items_qc"] == 'Rejected'){?>
                                                          <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'qc_qc_approval_view.php?id=<?php echo($row['id']); ?>&pro=<?php echo($row['pro_no_qc']); ?>',
                                                                                  '<?php echo($row['id']); ?>')"; 
                                                                  ></span>
                                                                  <?php
                                                         }
