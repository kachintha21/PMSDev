...
$mc = new DecalInsCycletime(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
...
if (isset($_GET['id'])) {
   $mc->deleteMachineCalendar($_GET['id']);
    header("location:decal_ins_cycletime_view.php");
    exit();
}
?>
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Decal Ins Cycle Time</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Decal Ins Cycle Time
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="decal_ins_cycletime_view.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> 

                                <i class="fa fa-angle-right"></i>

                                Decal Ins Cycle Time
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Decal Ins Cycle Time
  ...
  <input  type="hidden" class="form-control"  name="id" id="id"        value="<?php
                                        ...
                                        <div class="form-body">                   
											 ...
											 <div class="form-group form-group">
                                                ...
                                                <label class="control-label col-sm-2">Time Taken to Arrange 100 Sheets(min)<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">
                                                    <input  type="text" class="form-control" name="arrange" id="arrange" 
                                                            />                         
                                                </div>  



                                                 <label class="control-label col-sm-2">Time Taken to Inspect 100 Sheets(min)<span style="color: crimson;"> *</span></label>
                                               <div class="col-sm-2">
                                          ...
                                          <div class="form-group form-group">
                                                ...
                                                <label class="control-label col-sm-2">Seal Application Time(min)<span style="color: crimson;"> *</span></label>
                                                 <div class="col-sm-2">
                                                    <input  type="text" class="form-control" name="seal" id="seal" 
                                                            />                         
                                                </div> 



                                                 <label class="control-label col-sm-2">Date Input Time(min)<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">
                                                    <input  type="text" class="form-control" name="datain" id="datain" 
                                                            />                         
                                                </div> 
            ...
            <script src="../ajax_post/decal_ins_cycletime_post.js"></script>
