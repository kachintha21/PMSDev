...
$oilData = new OilData(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>NLPL |Daily Pigment Plan </title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <table style="width:100%">
                                    <tr>
                                        <th rowspan="" > Pigment mixing  Daily Printing Plan-<?php echo($vp_data[1]); ?> 
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td> Pro:No</td><td>Design</td><td>Lot No</td>
                                        <td>Total sheets</td>
                                        <td>
                                            #
                                            colors
                                        ...
                                        <td>
                                            Pigment Requirement(ES)
                                        </td>

                                     

                                        <td>
                                            Total  Pigment Requirement(ES)
                                        </td>
                                        
                                        
                                        <td>
                                            Total oil Requirement(ES)
                                        </td>
                                    ...
                                    $query = "SELECT * FROM virtual_planner_final_tbl WHERE pro_no_vpft!='N/A'  AND plan_colors_vpft!='S00' AND ref_no_vpft='" . $_GET['id'] . "' ORDER BY id  ASC
 ...
 ";
                                    ...
                                    if ($result = $conn->query($query)) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            $pigmentConsumption = $pcm->getPigmentConsumptionMasterCodeByPatternNo($row["pro_no_vpft"], $row["plan_colors_vpft"]);
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                    ...
                                                    <?php
                                                    $date = new DateTime($row['date_vpft']);
                                                    $date->modify('-1 day');
...
//                                                    echo($stop_date);
                                        ...
                                        <td>
                                            <?php
                                            $ttt = $pigm->getNumberPigmentMasterByNo($row['design_vpft']);
                                            echo($ttt);
                                            ?> 

                                        </td>
										<td><?php 
										$str = trim($row['plan_colors_vpft'], "S0");
										 $rem = $pigm->getremarks($row['pro_no_vpft'],$row['design_vpft'],$row['lot_vpft'],$row['date_vpft'],$str );
                                        ...
                                        <td>
                                            ...
                                            $plan_rest_value = $row['item07_pdst'];
                                            $ref_no_pdst = $row['design_vpft'] . $index;
                                            ?>
										...
										$str = trim($row['plan_colors_vpft'], "S0");
										 ...
										 $rem_close = $pigm->getclose($row['pro_no_vpft'],$row['design_vpft'],$row['lot_vpft'],$row['date_vpft'],$str);
                                        ...
                                        <td>
                                            <?php
                                            $res = "SELECT * FROM colours_tbl WHERE pattern_no_ct='" . $row['design_vpft'] . "'   AND  colours_code_ct='" . $row['plan_colors_vpft'] . "'    ";
                                            if ($resc = $conn->query($res)) {
                                                ...
                                                while ($rowsc = $resc->fetch_assoc()) {
                                                    ...
                                                    $oill=$oilData->getOilDataCusumpationPatternNo($row['design_vpft'],$row['plan_colors_vpft']);
                                                    
                                                 
                                              

                                                    $qty_ct = $rowsc['qty_ct'];
                                                    $Required = ($rowsc['item02_ct'] * $row['imp_plan_vpft']) * $qty_ct / 100;
                                                    $total_pigment += $Required;

                                                    echo($rowsc['pigment_name_ct'] . "-" . $rowsc['qty_ct'] ."%". "-". $Required . "<br>");
                                                }
                                            }
                                            ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                            echo($total_pigment + $totalConsumption);
                                            ?>
                                        </td>
                                          ...
                                          <td>
                                            ...
                                            <?php
                                            echo(round(($total_pigment + $totalConsumption)*$oill[6]/1+$oill[6],2) );
                                            ?>
                                        </td>
...
//                                                    $_POST['id'], $ref_no_pdst, $index, $date->format('Y-m-d'), $row['production_no_pdst'], $row['pattern_no_pdst'], $row['lot_no_pdst'], $row['num_sheets'], $ttt, $row['colour_index_pdst'], '0', $_POST['actual_ppt'], $colours_name_ct, $_POST['item02_ppt'], $_POST['item03_ppt'], $_POST['item04_ppt'], $_POST['item05_ppt'], $loge_user, getServerDate(), getServerTime()
//                                            );
//                                     
                                    ...
                                    if ($_GET['ID']) {
                                        ...
                                        $id = 'N/A';
                                        $ID_ppft = $row['ID_vpft'];
                                        $ref_no_ppft = $row['ref_no_vpft'];
                                        $design_ppft = $row['design_vpft'];
                                        $pro_no_ppft = $row['pro_no_vpft'];
                                        $lot_ppft = $row['lot_vpft'];
                                        $plan_colors_ppft = $row['plan_colors_vpft'];
                                        $mesh_type_ppft = 'N/A';
                                        $colors_name_ppft = $colours_name_ct;
                                        $pigment_total_ppft = $total_pigment + $totalConsumption;
                                        $date_ppft = $date->format('Y-m-d');
                                        $change_over_ppft = $index;
                                        $time_ppft = $row['time_vpft'];
                                        $shfit_ppft = 'N/A';
                                        $start_date_ppft = 'N/A';
                                        $finish_date_ppft = 'N/A';
                                        $imp_plan_ppft = $row['imp_plan_vpft'];
                                        $imp_actual_ppft = '0';
                                        $estimate_time_ppft = '0';
                                        $remarks_ppft = '0';
                                        $is_edit_ppft = '0';
                                        $item01_ppft = $row['machine_no_vpft'];
                                        $item02_ppft = 'N/A';
                                        $item03_ppft = 'N/A';
                                        $item04_ppft = 'N/A';
                                        $item05_ppft = 'N/A';
                                        $org_name_ppft = $loge_user;
                                        $org_date_ppft = getServerDate();
                                        $org_time_ppft = getServerTime();


                                        $ppf->createNewPigmentPlannerFinal($id, $ID_ppft, $ref_no_ppft, $design_ppft, $pro_no_ppft, $lot_ppft, $plan_colors_ppft, $mesh_type_ppft, $colors_name_ppft, $pigment_total_ppft, $date_ppft, $change_over_ppft, $time_ppft, $shfit_ppft, $start_date_ppft, $finish_date_ppft, $imp_plan_ppft, $imp_actual_ppft, $estimate_time_ppft, $remarks_ppft, $is_edit_ppft, $item01_ppft, $item02_ppft, $item03_ppft, $item04_ppft, $item05_ppft, $org_name_ppft, $org_date_ppft, $org_time_ppft);
                                    }
                                }
                            }
                            ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 invoice-block">
                        ...
                        if (empty($_GET['ID'])) {
                            ?>
                            <a class="btn btn-lg blue hidden-print margin-bottom-5"                   onclick="PlanSaveConfirm('<?php echo($_GET['id']); ?>', 'pigment_planner.php?id=<?php echo($_GET['id']); ?>&ID=<?php echo ('save'); ?>',
                                                '<?php echo($_GET['id']); ?>')";  >
                                Save Plan <i class="fa fa-check"></i>
                            </a>

                        <?php } else { ?>
                            <a class="btn btn-lg blue hidden-print margin-bottom-5"                   onclick="PlanResetConfirm('<?php echo($_GET['id']); ?>', 'pigment_planner_delete.php?id=<?php echo($_GET['id']); ?>',
                                                '<?php echo($_GET['id']); ?>')";  >
                                Reset Plan <i class="fa fa-check"></i>
                            </a>
