...
<html lang="en">
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
        ...
        <div class="page-container">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="printing_order_details.php">WIP(<?php
                                    echo($ps->getWIPByProces($pname));
                                    ?>)
                            ...
                            <li>
                                ...
                                <a href="printing_order_details.php">Daily(4)
                            ...
                            <i class="fa fa-angle-right"></i>
                            <li>
                                <a href="layout_film_outing.php">Changed Pattern
                                </a>
                            </li>
                        </ul>
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <select class="form-control"   onchange="return form_ajax();"  name="pnumber"  id="pnumber">
                                                        <?php echo($ps->getProductStatus($pname)); ?>  
                                                    </select>   
                                                </div> 
                                            ...
                                            <div  id="insert_response_ajax" style="color: #FF0000;  font-family: Tahoma; font-size: 12px;  font-weight: bold; text-align: left; " >
                                            </div>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button type="button" class="btn purple" onClick="return form_ps();" > <i class="fa fa-check"></i> Save </button>
            ...
            <script src="../ajax_post/layout_film_outing_new.js"></script>
