...
$col = new Colours(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
$pi = new PigmentMaster(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Colours Master</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Colours Master
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="colour_data.php"> View

                                </a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <a href="#">Colours Master
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Colours Master </div>
                                                        ...
                                                        <table class="table table-bordered table-hover" id="tab_logic">
                                                            <thead>
                                                                <tr>                            
                                                                    ...
                                                                    <th class="text-center" width="10%">Pigment</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr id='addr0'>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input type="text" name='pigment_name_ct[]' id='pigment_name_ct[]' placeholder='Pigment Name' class="form-control qty"
                                                                               />
                                                                    </td>

                                                                    <td><input type="text" name='qty_ct[]' id='qty_ct[]' placeholder='Qty'   type="text"  class="form-control name" /></td>
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button type="button" class="btn purple" onClick="return form_submit();" > <i class="fa fa-check"></i> Save Colours </button>
