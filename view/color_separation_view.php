                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'color_separation_ps.php';">
                                                        Color Separation<i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM color_separation_tbl ORDER BY id DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["lot_no_sc"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["judgment_sc"]); ?> 
                                                        </td>
                                                      
             

                                                        <td>      
                                                            <?php echo($row["org_time_sc"]); ?> 
                                                        </td>  
