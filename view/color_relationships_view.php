...
<html lang="en">
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'color_relationships.php';">
                                                     New Pattern <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM color_relationships_tbl  order by Id DESC LIMIT 200";
                                            ?>  
        ...
        <?php echo($row["col_no_crt"]); ?> 
                                                        </td>


                                                        <td>
        <?php echo($row["col_name_crt"]); ?>
                                                        </td>


                                                        <td>
        <?php echo($row["ndesign_no_crt"]); ?>
                                                        </td>
                                                        
                                                        
                
                                                        <td>
        <?php echo($row["ncol_no_crt"]); ?>
                                                        </td>                                        
                                                        
                                                        
                
                                                        <td>
        <?php echo($row["ncol_name_crt"]); ?>
                                                        </td>   
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'color_relationships.php?id=<?php echo($row['id']); ?>',
                                                                                          '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
