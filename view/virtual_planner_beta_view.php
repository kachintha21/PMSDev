                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'virtual_planner_beta.php';">
                                                        Virtual Planner  <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
...
<!--                                                <th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM virtual_planner_tbl ORDER BY date_vt desc ";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td><?php echo($row["ref_no_vt"]) ?></td>


                                                        <td>
                                                            <?php if ($vts->confirmvirtualTimeStoreEntity($row["ref_no_vt"]) == 0) { ?>
                                                                <a href="plan_query.php?id=<?php echo($row["ref_no_vt"]) ?>">
                                                                    <span class="glyphicon glyphicon-wrench" aria-hidden="true" style="cursor:pointer">
                                                        ...
                                                        <td>
                                                            <?php if ($vts->confirmvirtualTimeStoreEntity($row["ref_no_vt"]) > 0) { ?> 
                                                                ...
                                                                <a href="virtual_printing_planne_view.php?id=<?php echo($row["ref_no_vt"]) ?>">
                                                                    <span class="glyphicon glyphicon-compressed" aria-hidden="true" style="cursor:pointer">
                                                        ...
                                                        <!-- 
                                                                                                              <td>
                                                                                                                  <a href="virtual_printing_planner.php?id=<?php echo($row["ref_no_vt"]) ?>">
                                                      
                                                        <?php echo($row["ref_no_vt"]); ?> 
                                                      
                                                                                                                  </a>
                                                                                                              </td>
                                                      
                                                                                                              <td>
                                                                                                                  <a href="virtual_printing_planner_edit.php?id=<?php echo($row["ref_no_vt"]) ?>">
        ...
        <!--                                                        <td>
                                                                    <a href="top_coat_planner.php?id=<?php echo($row["ref_no_vt"]) ?>">
                                                        ...
                                                        <td>
                                                            <?php if ($vts->confirmvirtualTimeStoreEntity($row["ref_no_vt"]) > 0) { ?> 
                                                            <a href="pigment_planner.php?id=<?php echo($row["ref_no_vt"]) ?>">
                                                        ...
                                                        <td>
                                                            <?php if ($vts->confirmvirtualTimeStoreEntity($row["ref_no_vt"]) > 0) { ?> 
                                                            <a href="new_screen_planner.php?id=<?php echo($row["ref_no_vt"]) ?>">



                                                                <span class="glyphicon glyphicon-film" aria-hidden="true" style="cursor:pointer">
                                                        ...
                                                        <td>      
                                                            <?php echo($row["org_date_vt"]); ?> 
                                                        </td>                

                                                        <td>      
                                                            <?php echo($row["org_time_vt"]); ?> 
                                                        </td>  

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'virtual_planner_beta_delete.php?id=<?php echo($row['ref_no_vt']); ?>',
                                                                                          '<?php echo($row['ref_no_vt']); ?>')"; 
                                                                  ></span></td>
