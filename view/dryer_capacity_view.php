                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'dryer_capacity.php';">
                                                        Dryer Capacity <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM dryer_capacity_tbl ORDER BY id DESC";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php echo($row["machine_no_dct"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["capacity_dct"]); ?> 
                                                        </td>
                                                        <td>

                                                            <?php echo($row["is_edit_dct"]); ?> 
                                                        </td>
                                                        ...
                                                        <td>      
                                                            <?php echo($row["org_date_dct"]); ?> 
                                                        </td>                

                                                        <td>      
                                                            <?php echo($row["org_time_dct"]); ?> 
                                                        </td>  

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'dryer_capacity.php';">
                                                            </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'dryer_capacity.php?ID=<?php echo($row["id"]); ?>';" >
                                                            </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'dryer_capacity.php?id=<?php echo($row['id']); ?>',
                                                                                  '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
