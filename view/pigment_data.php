...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Printing Index</title>
...
<th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM pigment_master_tbl WHERE pattern_pm='" . $_GET['id'] . "'  ORDER BY pattern_pm DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="colour_data.php?id=<?php echo($row["id"]);?>" > Pigment </a>
                                                        </td>

                                                        <td>
                                                             <a href="oil_data.php?id=<?php echo($row["id"]);?>" >Oil</a> 
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php echo($row["org_date_pm"]); ?>
                                                        </td>


                                                        <td>
                                                            <?php echo($row["org_time_pm"]); ?>
                                                        </td>
...
<td style="width:50px; text-align:center;">
                                                            ...
                                                            <a href="pigment_edit.php?id=<?php echo($row['id']); ?>">Edit</a>
...
<!--                                                         
                                                            ...
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="updateEntity('<?php echo($row['id']); ?>', 'pigment_master_edit.php?id=<?php echo($row['id']); ?>',
                                                                                  '<?php echo($row['pattern_pm']); ?>')"; 
                                                                  ></span></td> -->

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'pigment_master.php?id=<?php echo($row['id']); ?>',
                                                                                  '<?php echo($row['pattern_pm']); ?>')"; 
                                                                  ></span></td>
