...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake| Inspection  Data With Curve </title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="dinspection_view_curve_wise.php">Inspection Data With Curve </a>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i >Inspection Data With Curve</i>
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = '';">
                                                        Inspection Data With Curve <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT aa.pro_no,c.decal_no_lpt,c.curve_no_lpt,c.planned_qty_lpt,c.no_of_curves_lpt,bb.ins_qty*c.no_of_curves_lpt AS total_ins 
,aa.1st*c.no_of_curves_lpt AS 1st ,aa.2nd*c.no_of_curves_lpt AS 2nd ,c.lot_no_lpt
FROM  (SELECT a.pro_no,SUM(a.1st) AS 1st,SUM(a.2nd) AS 2nd FROM tbl_cut_ins_plan_ins_data_with_2nd a GROUP BY a.pro_no) aa 
LEFT JOIN (SELECT b.pro_no,SUM(b.qty) AS ins_qty from tbl_cut_ins_plan_ins_data b GROUP BY b.pro_no) bb
ON aa.pro_no = bb.pro_no
LEFT JOIN layout_plans_tbl c
ON aa.pro_no=c.pro_no_lpt";
                                            ?>  
