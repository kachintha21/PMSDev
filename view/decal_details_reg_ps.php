...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Decal Details Registration Pattern Select</title>
...
?>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Decal Details Registration Pattern Select
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Decal Details Registration Pattern Select
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Decal Details Registration Pattern Select
                                    </div>
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <div class="form-body">            
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <select  class="form-control" name="pattern_no_plt"  id="pattern_no_plt">
