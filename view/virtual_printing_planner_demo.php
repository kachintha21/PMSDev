...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>KIK |Daily Printing Plan </title>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <table style="width:100%">
                                    <tr>
                                        <th rowspan="" >Daily Printing Plan-<?php echo($vp_data[1]); ?> 

                                            <?php
                                            $machine_no_pdst = "M01";
                                            $Operator = $vp_data[3];
                                            $dryer_capacity = 1200;
                                            $process_name_pdst = "Printing";
                                            ?>
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:10%"><b><?php echo($machine_no_pdst); ?></b></td>
                                        <td style="width:10%">Dryer capacity</td>

                                        <td style="width:10%"><b><?php echo($dryer_capacity); ?></b></td>
                                    </tr>
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        </td>     <td>Time</td>   <td>Start
                                            Date
                                        </td>   <td>Patt. Finish
                                            Date
                                        </td> <td> Pro:No</td><td>Design</td><td>Lot</td><td>#
                                            colors
                                        </td><td>Imp-Plan</td><td>Imp-Actual</td><td>Plan colors
...
//$time_duration_fp=$time_fp
                                    ...
                                    <tr>
                                        <td>#
                                        ...
                                        </td>     <td><?php echo($shift_start_time); ?></td>   <td>N/A
                                            N/A
                                        </td>   <td>
                                            N/A
                                        </td> <td> M/P Time</td><td>N/A</td><td>N/A</td><td>N/A

                                        </td><td>N/A</td><td>N/A</td><td>N/A
                                            ...
                                            $res = $pds->createNewPrintingDynamicStatus(
                                                    $id, $_GET['id'] . '_M/P', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', $shift_start_time, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', $loge_user, getServerDate(), getServerTime()
                                            );
                                            ?>
                                        <td>N/A
                                        </td>
                                    ...
                                    <tr>
                                        <td>#
                                            ...
                                            //$first_ptime = AddPlayTime($shift_start_time, $prepare_time);

                                            $first_ptime = appendTime($shift_start_time, 15);
                                            //$three_time=AddPlayTime($first_ptime,$time_duration_fp);
                                            ...
                                            N/A
                                        </td> <td> P/P Time</td><td>N/A</td><td>N/A</td><td>N/A
                                        ...
                                        ///echo($three_time);
                                        $res = $pds->createNewPrintingDynamicStatus(
                                                $id, $_GET['id'] . '_P/P', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', $firstPrinting, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', $first_ptime, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', $loge_user, getServerDate(), getServerTime()
                                        );
                                        ?>
...
ORDER BY pigment_master_tbl.colours_pm ASC LIMIT  1000";
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?></td>   <td><?php
                                                    echo($row['ship_scheduled_date_vpt']);
                                                    ?>
                                                </td>   <td><?php
                                                    echo($row['ship_scheduled_date_vpt']);
                                                    ?>
                                                    ...
                                                    ?></td><td><?php
                                                        echo($row['lot_no_vpt']);
                                                        ?></td><td><?php
                                                        echo( $pigm->getNumberPigmentMasterByNo($row['item01_vpt']));
                                                        ?> 
                                                </td>  <td style="<?php
                                                if ($sheetBreak > 500) {
                                            ...
                                            <?php
                                            // echo(strtotime("2000-01-01 09:30:00"));


                                          if (
                                                 strtotime("2000-01-01 " . $getTime . ":00") >= strtotime("2000-01-01 09:30:00") &&
                                                   strtotime("2000-01-01 " . $getTime . ":00") <= strtotime("2000-01-01 10:04:00")
                                          ) {
                                                ...
                                                ///echo($three_time);
                                                $res = $pds->createNewPrintingDynamicStatus(
                                                        $id, $_GET['id'] . '_Tea Time', 'N/A', 'N/A', 'Tea Time', 'N/A', 'N/A', $getTime, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', '30', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', '0', $loge_user, getServerDate(), getServerTime()
                                                );
                                                ?>
                                                <tr style="background-color: lightblue;">
                                                    <td></td>
                                                    <td><?php /*echo $getTime;*/ echo("09.30"); ?></td>
                                                    <td colspan="20">
                                                        Tea Time
                                                        ...
                                                        $TT=appendDdTime(strtotime("2000-01-01 09:30:00"),$oldtime);
                                                        $yyyy=round($oneSheetPerTime*$TT);
                                                        $int = (int)$yyyy;
                                                        
                                                        echo($row['qty_vpt'].",".$getTime." ,".$TT.",".$oneSheetPerTime." "."Number sheet:".round($oneSheetPerTime*$TT)." <br>");
                                                        echo("remain sheet:".$int);
                                                        ?>
                                                    </td>
                                                </tr> 

                                                <?php
                                                $getTime = appendTime($getTime, 30);
                                            }



                                            if (
                                                    strtotime("2000-01-01 " . $getTime . ":00") >= strtotime("2000-01-01 12:00:00") &&
                                                    strtotime("2000-01-01 " . $getTime . ":00") <= strtotime("2000-01-01 13:00:00")
                                            ) {


                                                ///echo($three_time);
                                                $res = $pds->createNewPrintingDynamicStatus(
                                                        $id, $_GET['id'] . '_Lunch Time', 'N/A', 'N/A', 'Lunch Time', 'N/A', 'N/A', $getTime, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', '30', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', '0', $loge_user, getServerDate(), getServerTime()
                                                );
                                                ?>
                                                <tr style="background-color: lightblue;">
                                                    <td></td>
                                                    ...
                                                    <td colspan="20">
                                                        Lunch Time-<?php echo($row['qty_vpt']); ?>
                                                    </td>
                                                </tr> 
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:10%"><b><?php echo('N/A'); ?></b></td>
