                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Printing Speed Master </a>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'printing_speed_master_ps.php';">
                                        Printing Speed Master <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
...
Date
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT * FROM printing_speed_master_tbl ORDER BY id DESC";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php echo($row["pattern_no_psmt"]); ?> 
                                                        </td>

                                                        <td>
                                                            <?php echo($row["color_index_psmt"]); ?> 
                                                        </td>
                                                        <td>
                                                            <?php echo($row["printing_speed_psmt"]); ?> 
                                                        </td>
                                                        
                                                          <td>
                                                            <?php echo($row["is_edit_psmt"]); ?> 
                                                        </td>

                                                        <td>      
                                                            <?php echo($row["org_date_psmt"]); ?> 
                                                        </td>              

                                                        <td>      
                                                            <?php echo($row["org_time_psmt"]); ?> 
                                                        </td>  
                                                        
                                                                                  
                                                  <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'printing_speed_master_ps.php';">
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'printing_speed_master.php?ID=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                         <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'printing_speed_master.php?id=<?php echo($row['id']); ?>',
                                                                                  '<?php echo($row['id']); ?>')"; 
                                                          ></span></td>
