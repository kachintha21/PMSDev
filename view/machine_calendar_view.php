...
<html lang="en">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'machine_calendar.php';">
                                                        Machine Calendar <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
  ...
  <th>    
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM machine_calendar_tbl ORDER BY id DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["number_shift_mlt"]); ?> 
                                                        </td>

                                                        <td>

                                                            <?php echo($row["work_time_mlt"]); ?> 
                                                        </td>
                                                        
                                                          <td>

                                                            <?php echo($row["item01_mlt"]); ?> 
                                                        </td>
                                                        
                                                        
                                                            <td>

                                                            <?php echo($row["is_edit_mlt"]); ?> 
                                                        </td>
                                                        ...
                                                        <td>      
                                                            <?php echo($row["org_date_mlt"]); ?> 
                                                        </td>                

                                                        <td>      
                                                            <?php echo($row["org_time_mlt"]); ?> 
                                                        </td>  
                                                        
                                                                  <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'machine_calendar.php';">
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'machine_calendar.php?ID=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'machine_calendar.php?id=<?php echo($row['id']); ?>',
                                                                                          '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
