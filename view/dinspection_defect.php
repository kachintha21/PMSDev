...
<!--                                                                <th with="20%" >Printing Pattern </th>-->
 <th width="3%" style="width:15%">Pattern </th>
                                                                    <th width="3%" style="width:15%">CurveNumber</th>
                                                                    <th width="26%" style="width:15%" >Good <br> Quantity</th>
                                                                    <th width="26%" style="width:15%" >Register <br> Quantity</th>
																	<th width="26%" style="width:15%" >Top Coat <br> Quantity</th>
																	<th width="26%" style="width:15%" >Dust <br> Quantity</th>
																	<th width="26%" style="width:15%" >Line <br> Quantity</th>
																	<th width="26%" style="width:15%" >Embose <br> Quantity</th>
																	<th width="26%" style="width:15%" >Pin Hole <br> Quantity</th>
																	<th width="26%" style="width:15%" >Others <br> Quantity</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <?php ?>
																		...
																		$query = "SELECT * FROM layout_plans_tbl a WHERE a.pro_no_lpt ='" . $session_pattern_no . "' ORDER BY a.curve_no_lpt ";
...
<td><input size="10" type="numner" name='decal_no_dt[]' id='decal_no_dt[]'   class="form-control" placeholder="Remarks" min="0" value="<?php echo $row['decal_no_lpt']; ?>"  /></td>
                                                                    ...
                                                                    <td><input size="10" type="numner" name='Good[]' id='Good[]'   class="form-control" placeholder="Good" min="0" value=""  /></td>
                                                                    <td><input size="10" type="numner" name='Register[]' id='Register[]'   class="form-control" placeholder="Register" min="0" value=""  /></td>
                                                                    <td><input size="10" type="numner" name='Top[]' id='Top[]'   class="form-control" placeholder="Top Coat" min="0" value=""  /></td>
                                                                    <td><input size="10" type="numner" name='Dust[]' id='Dust[]'   class="form-control" placeholder="Dust" min="0" value=""  /></td>
                                                                    <td><input size="10" type="numner" name='Line[]' id='Line[]'   class="form-control" placeholder="Line" min="0" value=""  /></td>
                                                                    <td><input size="10" type="numner" name='Embose[]' id='Embose[]'   class="form-control" placeholder="Embose" min="0" value=""  /></td>
                                                                    <td><input size="10" type="numner" name='Pin[]' id='Pin[]'   class="form-control" placeholder="Pin Hole" min="0" value=""  /></td>
                                                                    <td><input size="10" type="numner" name='Others[]' id='Others[]'   class="form-control" placeholder="Others" min="0" value=""  /></td>
                                                                      </tr>
                                                ...
                                                <div  hidden class="row clearfix">
                                                    <div class="col-md-12">
                                                        <button hidden id="add_rowp" type="button" class="btn btn-default pull-left">Add Row</button>
                                                        <button hidden id='delete_rowp' type="button" class="pull-right btn btn-default">Delete Row</button>
                                                    </div>
                                                </div>
            ...
            <script src="../ajax_post/di_defect_post.js"></script>
