...
<head>
<meta charset="utf-8"/>
<title>Noritake|Production Planning Tools </title>
             ...
             <input  type="hidden" class="form-control"  name="depart_tt" id="depart_tt"  value="<?php echo($loge_depart);?>" />
                    ...
                    <div class="form-body">                    
                          ...
                          <div class="form-group form-group-sm">
						   ...
						   <div class="col-sm-2">
                     <input type="text" class="form-control" name="item" id="item" placeholder='item Name' maxlength="20" onkeypress="return form_submit();"/>                           
                           </div>


                            <div class="col-sm-2">
                          <input type="date" class="form-control" name="date1" id="date1"  maxlength="20" onchange="return form_submit();" 
          ...
          <p></p>
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-cogs"></i>Production Planning Tools
							</div>
							<div class="tools">
						...
						<div class="portlet-body" id="insert_response" >
...
<?php
    ...
    ?>
<script src="../ajax_post/_post.js"></script>
