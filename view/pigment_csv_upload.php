...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake |Pigment CSV Upload</title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="pigment_csv_upload_view.php"    > View
                            ...
                            <i class="fa fa-angle-right"></i>
                                  <li>
                                <a href="truncate.php"  onclick="truncate('<?php echo("truncate"); ?>', 'truncate.php?id=<?php echo("truncate"); ?>',
                                                                                  '<?php echo("truncate"); ?>')" > TRUNCATE Table
                                </a>
                            </li>
                            ...
                            <i class="fa fa-angle-right"></i>
                                  <li>
                                <a  onclick="TableUpdate('<?php echo("TableUpdate"); ?>', '../csv/run.php?id=<?php echo("TableUpdate"); ?>',
                                                                                  '<?php echo("TableUpdate"); ?>')" >All Table Update
                                </a>
                            </li>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Pigment CSV Upload</div>
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                  <form class="form-horizontal" action="pigment_csv_upload_process.php" method="post"  enctype="multipart/form-data">

                                        <input  type="hidden" class="form-control"  name="ref_no_st" id="ref_no_st"  value="<?php echo($se->getNextSectionRefNo("section_tbl", "NLPLSE")); ?>" />


                                        <input  type="hidden" class="form-control"  name="org_date_st" id="org_date_st"  value="<?php echo($loge_user); ?>" />


                                        <div class="form-body">                    

                                            <div class="form-group form-group-sm">
                                                <label class="control-label col-sm-2">Select CSV File <span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-2">
                                                   <button type="submit" id="submit" name="Import" class="btn btn-primary " data-loading-text="Loading...">CSV Import</button>
...
<script src="../ajax_post/section_post.js"></script>
