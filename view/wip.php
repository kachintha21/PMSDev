...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Report[WIP]</title>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT SUM(item01_dt) as item01_dt,SUM(remain_qty_dt) as remain_qty_dt,lot_no_dt,curve_no_dt,SUM(planned_qty_dt) as planned_qty_dt   FROM dinspection_tbl WHERE judgment_dt='1' GROUP BY curve_no_dt  ORDER BY id DESC";
                                            ?>  
