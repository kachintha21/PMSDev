                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'past_layout_details.php';">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM past_layout_details_tbl Where  id='47327' ORDER BY id DESC";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a  href="pigment_data.php?id=<?php echo($row["pro_no_pldt"]); ?>">
                                                                <?php echo($row["pro_no_pldt"]); ?> 
                                                            </a>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php echo($row["design_no_pldt"]); ?> 
                                                        </td>



                                                        <td>
                                                            <?php echo($row["lot_no_pldt"]); ?> 
                                                        </td>



                                                        <td>
                                                            <?php echo($row["sheet_pldt"]); ?> 
                                                        </td>



                                                        <td>
                                                            <?php echo($row["qty_pldt"]); ?> 
                                                        </td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'past_layout_details.php?id=<?php echo($row['pro_no_pldt']); ?>',
