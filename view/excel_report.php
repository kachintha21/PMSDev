...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|General  Report </title>
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                      ...
                                                      <?php
                                                        $date = "SELECT * FROM product_status_tbl Where production_no_pt='" . $row["pro_no_lpt"] . "' AND  lot_no_pt='" . $row["lot_no_lpt"] . "'  LIMIT 1";
                                                          if ($resd = $conn->query($date)) {
                                                            while ($rowd = $resd->fetch_assoc()) {
                                                                ?> 
                                                        
                                                         <td>      
                                                              <?php echo($rowd["shipment_request_pt"]); ?> 
                                                        </td>  
                                                             <?php }
                                                        } ?>
                                                        ...
                                                        <?php
                                                        $cu = "SELECT * FROM layout_plans_tbl Where pro_no_lpt='" . $row["pro_no_lpt"] . "' ";
                                                        ?>

                                                        <?php
                                                        if ($rest = $conn->query($cu)) {
                                                            while ($rowt = $rest->fetch_assoc()) {
                                                                ?>   
                                                                <?php echo("<td>" . $rowt["curve_no_lpt"] . "</td>" . ""); ?>
                                                            <?php }
                                                        } ?>
