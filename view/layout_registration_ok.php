...
<?php ?>
                                                                <tr id='addrp0'>
																	...
																	<td>
                                                                        ...
                                                                        <?php
                                                                        $query = "SELECT curve_no_cmt,decal_design_no_cmt,fg_design_no_cmt FROM curve_master_tbl WHERE  decal_design_no_cmt='" . $session_pattern_no . "' group by fg_design_no_cmt   ";
                                                                        ?>


                                                                        <select name="decal_no_lpt[]" id="decal_no_lpt[]" class="form-control product">
                                                                            <option value="">-Select-</option>
                                                                            <?php
                                                                            if ($result = $conn->query($query)) {
                                                                                while ($row = $result->fetch_assoc()) {
                                                                                    ?>  
                                                                                    <option  data-price="<?php echo($cm->getFGPatternByRefFG($session_pattern_no,$row['fg_design_no_cmt'])); //echo $row['decal_design_no_cmt'];   ?>"  data-name="<?php echo $row['fg_design_no_cmt']; ?>"    value="<?php echo $row['fg_design_no_cmt'] ?>">
																	...
																	<td><input type="text" name='curve_no_lpt[]' id='curve_no_lpt[]'      type="text"  class="form-control price" /></td>
