                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'printing_ps.php';">
                                                        Printing <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT a.pro_no_vpft AS production_no_pst,a.design_vpft AS pattern_no_pst,a.lot_vpft AS lot_no_pst,
a.plan_colors_vpft AS colors_name_ppft FROM virtual_planner_final_tbl a 
WHERE      a.plan_colors_vpft !='S00'  AND 
(a.status_vpft ='' ||  a.status_vpft ='0') ORDER BY CAST(a.time_vpft  AS INTEGER),a.id ASC  ";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <a href="printing.php?pro=<?php echo($row["production_no_pst"])?>&clr=<?php echo($row["colors_name_ppft"]); ?>">
