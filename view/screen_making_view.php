...
Date
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM screen_making_tbl ORDER BY id DESC";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="barcode_re_print_sm.php?id=<?php echo($row["id"]);?>">
                                                            <?php echo($row["pro_no_sm"]); ?> 
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["lot_no_sm"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["screen_mesh_sm"]); ?> 
                                                        </td>
                                                      

                                                        <td>

                                                            <?php echo($row["judgment_sm"]); ?> 
                                                        </td>
    
                                                        <td>      
                                                            <?php echo($row["org_date_sm"]); ?> 
                                                        </td>                

                                                        <td>      
                                                            <?php echo($row["org_time_sm"]); ?> 
                                                        </td>  
