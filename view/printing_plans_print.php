                            ...
                            <h3> Noritake Printing Management Systems Layout Simulation tools <h3>
                                    ...
                                    <tr>
                                        ...
                                        <td  width="2%" >
                                             ...
                                             <a href="planning_data.php"    style="text-decoration: none"  >
                                        ...
                                        <td colspan="3" align="center">
                                            ...
                                            try {
                                                ...
                                                if (isset($_POST['save_plans']) && isset($_SESSION['selectedPlans']) && count($_SESSION['selectedPlans']) > 0) {
                                                    ...
                                                    $stmt = $conn->prepare("INSERT INTO saved_layout_plans_tbl (`ref_id`, layout, design, curve_no, curve_area, planned_qty, no_of_curves, no_of_sheets, close_curve_after, total_sheets_needed) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?,?) ");
                                                                ...
                                                                foreach ($plans as $plan) {
                                                                    ...
                                                                    if (is_array($plan['curves_sets'])) {
                                                                        foreach ($plan['curves_sets'] as $v) {
                                                                            ...
                                                                            $stmt->bind_param(
                                                                                    "ssssdiiiii", $refId, $layout, $design_fdt, $v['curve_no'], $v['curve_area'], $v['planned_qty'], $v['curves_per_sheet'], $v['no_of_sheets'], $v['close_curve_after'], $plan['total_no_of_sheets']
                                                                            );
