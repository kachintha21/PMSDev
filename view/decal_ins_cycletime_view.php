...
<html lang="en">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'decal_ins_cycletime.php';">
                                                        Decal Ins Cycle Time <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    Time Taken to <br>Arrange<br> 100 Sheets(min) 
                                                </th>
												<th>
                                                    Time Taken to <br>Inspect<br> 100 Sheets(min)
                                                </th>
												<th>
                                                    Seal Application<br> Time(min)
                                                </th>
												<th>
                                                    Date Input<br> Time(min)
                                                </th>
  ...
  <th>    
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM decal_ins_cycletime_tbl ORDER BY id DESC limit 50";
                                            ?>  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'decal_ins_cycletime.php?id=<?php echo($row['id']); ?>',
                                                                                          '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
