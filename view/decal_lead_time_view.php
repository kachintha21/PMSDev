                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'decal_lead_time.php';">
                                                   Decal Lead Time<i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
...
Decal Store
 ...
 <th>    
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM decal_lead_time_tbl ORDER BY id DESC";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>      
                                                            <?php echo($row["decal_store_dltt"]); ?> 
                                                        </td> 
                                                        
                                                        
                                                        
                                                                  <td>      
                                                            <?php echo($row["decal_cutting_dltt"]); ?> 
                                                        </td> 
                                                                  ...
                                                                  <td>      
                                                            <?php echo($row["qc_apporaval_dltt"]); ?> 
                                                        </td> 
                                                        
                                                        
                                                                                        <td>      
                                                            <?php echo($row["top_coat_dltt"]); ?> 
                                                        </td> 
                                                        
                                                                        
                                                                                        <td>      
                                                            <?php echo($row["recovery_dltt"]); ?> 
                                                        </td> 
                                                        
                                                        
                                                                                      <td>      
                                                            <?php echo($row["is_edit_dltt"]); ?> 
                                                        </td> 
                                                                           <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'decal_lead_time.php';">
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'decal_lead_time.php?ID=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'decal_lead_time.php?id=<?php echo($row['id']); ?>',
                                                                                  '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
