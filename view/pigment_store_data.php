...
<head>
<meta charset="utf-8"/>
<title>Noritake|Pigment Transaction
</title>
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<button  class="btn green" onclick="window.location='pigment_transaction.php';">
							...
							<tbody>
                                                          ...
                                                          <?php
                                                          $query = "SELECT * FROM pigment_store_tbl  GROUP BY id DESC";
                                                          ...
                                                          ?>  
                                                            ...
                                                            if ($result = $conn->query($query)) {
                                                             while ($row = $result->fetch_assoc()) {
                                                                     $issue=$pid->gePigmentIssuesByNo($row["ref_no_pst"]);
							...
							<tr>
								...
								<td>
                                                                    <a href="barcode.php?id=<?php echo($row["ref_no_pst"]);?>">
                                                                        
                                                                    
								<?php echo($row["ref_no_pst"]);?> 
                                                                    </a>
								</td>
                                        
								<td>
								<?php echo($row["printing_pattern_pst"]);?> 
								</td>
								...
								<td>									
							        <?php echo($row["weight_pst"]);?> 
								</td>
                                                               	<td>									
							        <?php echo($row["item01_pst"]);?> 
								</td> 
                                                                
                                                                
 
                                                                						<td>									
							        <?php echo($row["comment_pst"]);?> 
								</td>
                                                                						...
                                                                						<td>									
							        <?php echo($row["org_date_pst"]);?> 
								</td>
                                                                
                                                                						<td>									
							        <?php echo($row["org_time_pst"]);?> 
								</td>
                                                      
                                                                
                                                                        <td style="width:50px; text-align:center;">
                              <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                          onclick="deleteEntity('<?php echo($row['id']);?>','pigment_transaction.php?id=<?php echo($row['id']);?>',
			'<?php echo($row['id']);  ?>')"; 
			 ></span></td>
