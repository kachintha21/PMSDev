...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Printing Order Details</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1.0" name="viewport"/>
        <meta http-equiv="Content-type" content="text/html; charset=utf-8">
        <meta content="Noritake|Printing Order Details" name="description"/>
        <meta content="Noritake|Printing Order Details" name="author"/>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Printing Order Details </a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'layout_registration.php';">
...
<!--                                                <th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM preparing_layout_tbl  ORDER BY id DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                   // if($row["id"]>585){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="decal_printing.php?id=<?php echo($row["pro_no_plt"])?>">  <?php echo($row["pro_no_plt"]); ?> </a>
                                                        </td>
...
<!--
        ...
        <?php echo($row["is_edit_plt"]); ?> 
                                                        ...
                                                        <td>
        <?php if($row["org_name_plt"]==""){ echo("-");} else{ echo($row["org_name_plt"]);}?> 
                                                        </td>
        ...
        <?php echo($row["org_time_plt"]); ?>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'printing_order_details_delete.php?id=<?php echo($row['pro_no_plt']); ?>',
                                                                                  '<?php echo($row['pattern_pm']); ?>')"; 
                                                                  ></span></td>
                                                                  
                                                                  <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'layout_registration_edit.php?ID=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>
