...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake| Decal Inspection Defect  Data </title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Decal Inspection Defect Data </a>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'dinspection_ps_defect.php';">
                                                        Decal Inspection Defect Data <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
 ...
 <th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT pattern_no_dt,a.lot_no_dt,a.pro_no_dt,a.curve_no_dt,SUM(a.Good) AS Good,SUM(a.Register) AS Register,SUM(a.Top) AS Top
,SUM(a.Dust) AS Dust,SUM(a.Line) AS Line,SUM(a.Embose) AS Embose,SUM(a.Pin) AS Pin,SUM(a.Others) AS Others 
FROM tbl_cut_ins_defect_data a
GROUP BY a.pro_no_dt,a.curve_no_dt
ORDER BY id DESC";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                            ...
                                                            <?php echo($row["pattern_no_dt"]); ?> 
                                                                <a>   
                                                        </td>
                                                        
                                                        <td>
                                                         
                                                            <?php echo($row["pro_no_dt"]); ?> 
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["lot_no_dt"]); ?> 
                                                        </td>
                                                        
                                                      
     <td>

                                                            <?php echo($row["curve_no_dt"]); ?> 
                                                        </td>
