...
if (isset($_GET['id'])) {
   ...
   $resp = $drn->updateDecalReceivedNoteById($_GET['id'],'', 2);
    $drn->deleteDecalReceivedNote($_GET['id']);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Decal Received Note</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <h3 class="page-title">Decal Received Note
 <small></small>
                    </h3>
                    <div class="page-bar">
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Decal Received Note
                                    </div>
<!--                                    <div class="tools"> <a href="javascript:;" class="collapse"> </a> </div>-->
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_drt" id="org_name_drt"  value="<?php echo($loge_user); ?>" />
                                        ...
                                        <div class="form-body"> 
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <input  type="text"     onkeyup="return form_ajax();"  class="form-control" name="ref_no_drn" id="ref_no_drn"  />
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea rows="5" cols="40" name="remakes_drt" id="remakes_drt" >-</textarea>
...
<script src="../ajax_post/decal_received_note.js"></script>
