                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT a.*,b.ins_complete FROM tbl_cut_ins_plan_ins_data a 
LEFT JOIN (SELECT * from tbl_cut_ins_planner_wise_data c  GROUP BY c.pro_no) b
...
ORDER BY a.id desc";
    ...
    <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php 
                                                            if($row["ins_complete"] == 1){
                                                                echo "Lot Finished";
                                                            }
                                                            else{
                                                                echo "Lot Not Finished";
                                                            } ?> 
                                                        </td>
