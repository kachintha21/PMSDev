...
if (isset($_GET['ID'])) {
    $data = $dc->getColoursCodeCodeById($_GET['ID']);
}

if (isset($_GET['id'])) {
    $dc->deleteColoursCode($_GET['id']);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Color Code Master </title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Color Code Master
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="color_code_view.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> 
...
?>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Color Code Master
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_cct" id="org_name_cct"  value="<?php echo($loge_user); ?>" />
 <input  type="hidden" class="form-control"  name="id" id="id"        value="<?php
                                        ...
                                        <input  type="hidden" class="form-control"  name="item03_cct" id="item03_cct" value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[6] + 1);
                                        }
                                                ?>" />
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                <label class="control-label col-sm-2">Color Code No<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-3">
                                                    <input  type="text" class="form-control"  name="color_code_cct" id="color_code_cct"  readonly  value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[2]);
                                        } else{
                                            echo($dc->getNextColoursCodeRefNo("color_code_tbl","")+1);
                                      ...
                                      <input  type="text" class="form-control"  name="color_name_cct" id="color_name_cct"  value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[3]);
                                        }?>"   />
            ...
            <script src="../ajax_post/color_code_master_post.js"></script>
