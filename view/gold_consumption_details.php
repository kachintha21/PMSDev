...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Gold consumption details</title>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Gold consumption details </a>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'atual_gold_consumpation.php';">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM gold_consumption_tbl  ORDER BY id DESC";
                                            ?>  
        ...
        <?php echo($row["fg_deign_gct"]); ?> 
                                                        ...
                                                        <td>
        <?php echo($row["pattern_no_gct"]); ?> 
                                                        </td>



                                                        <td>
        <?php echo($row["lot_no_gct"]); ?> 
                                                        </td>

                                                        <td>
        <?php echo($row["printing_gct"]); ?> 
                                                        </td>


                                                        <td>
        <?php echo($row["color_gct"]); ?> 
                                                        </td>



                                                        <td>
        <?php echo($row["item01_gct"]); ?> 
                                                        </td>


                                                        <td>
        <?php echo($row["consumption_gct"]); ?> 
                                                        </td>


                                                        <td>
        <?php echo($row["org_date_gct"]); ?>
                                                        </td>

                                                        <td>
        <?php echo($row["org_time_gct"]); ?>
                                                        </td>


                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'atual_gold_consumpation.php?id=<?php echo($row['pro_no_gct']); ?>',
                                                                                  '<?php echo($row['pro_no_gct']); ?>')"; 
                                                                  ></span></td>
