                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="top_coat_printing_view.php"> View
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT a.pro_no AS production_no_pst,a.design as pattern_no_pst,a.lot as lot_no_pst ,b.pro_no_tcpt
FROM tbl_top_coat_plan a 
LEFT JOIN top_coat_printing_tbl b
ON a.pro_no=b.pro_no_tcpt
WHERE b.pro_no_tcpt IS NULL GROUP BY a.pro_no ";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <a href="top_coat_printing.php?pro=<?php echo($row["production_no_pst"])?>">
