...
$pff = new PigmentPlannerFinal(DB_SERVER, DB_USERNAME, DB_PASSWORD, DB_DATABASE);
...
if ($_SESSION['logged_usr_id']) {
    ...
    if (isset($_GET["id"])) {
        $pff->updatePigmentPlannerFinalById($_GET["id"], '', '0', '', '');
    }
} else {
    session_start();
    session_unset();
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Pigment mixing plan </title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Pigment mixing plan
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Pigment mixing plan
                            </li>
                            <i class="fa fa-angle-right"></i></li>
                            <li> 
                                <a  target="_blank" href="machine_hold_details.php?project_no_tct=<?php echo($_GET['project_no_tct']); ?> &machine_no_vpft=<?php echo($_GET['machine_no_vpft']); ?> &date_vpft=<?php echo($_GET['date_vpft']); ?>  &hold=<?php echo('hold'); ?>'"  style="text-decoration: none" title="Hold Details" ><b>Hold(<?php echo($pff->getHoldPigmentPlanFinal($_GET['project_no_tct'], $_GET['machine_no_vpft'], $_GET['date_vpft'])); ?>)</b></a>                     
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li> 
                                <a href="#"  style="text-decoration: none" title="WIP Details" ><b>WIP(<?php echo($pff->getWipPigmentPlanFinal($_GET['project_no_tct'], $_GET['machine_no_vpft'], $_GET['date_vpft'])); ?>)</b></a>                     
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li> <a href="#"  style="text-decoration: none" title="Daily_Output" ><b>Daily_Output(<?php echo($pff->getDailyPigmentPlanFinal($_GET['project_no_tct'], $_GET['machine_no_vpft'], $_GET['date_vpft'])); ?>)</b></a> <i ></i> </li>
                        </ul>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Pigment mixing plan
                                        <?php
                                        if (isset($_POST["status"])) {
                                            $pff->updatePigmentPlannerFinalById($_POST["id"], $_POST["imp_actual_vpft"], 1, getServerDate(), getServerTime());
                                        }
                                        ?>
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="pigment_mixing_plan.php"  class="form-horizontal form-bordered" id="testform"  method="get">
                                                        ...
                                                        <table class="table table-bordered table-hover" id="tab_logic">
                                                            ...
                                                            <thead>
                                                                <tr>                                                                
																	...
																	<th class="text-center" width="5%">Change Over </th> 
																	<th class="text-center" width="5%">MC No </th> 
                                                                    <th class="text-center" width="10%">Required date</th>                     
                                                                    <th class="text-center" width="10%">Pro No
                                                                    </th>
                                                                    <th class="text-center" width="7%">Design
                                                                    </th>
                                                                    <th class="text-center" width="5%">Lot
                                                                    </th>                                                                    
                                                                    <th class="text-center" width="5%">Sheets Qty
                                                                    </th>                                                                     	
                                                                    <th class="text-center" width="5%">#color
                                                                    </th>                                                                    
                                                                    <th class="text-center" width="7%">P-colors
                                                                    </th>
                                                                    <th class="text-center" width="5%">Colors</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <?php
                                                                $query = "SELECT a.*,b.item01_pm FROM pigment_planner_final_tbl a
LEFT JOIN pigment_master_tbl b
ON a.design_ppft=b.pattern_pm AND a.plan_colors_ppft=b.colours_pm WHERE   a.date_ppft='" . $_GET['date_vpft'] . "' 
AND a.is_edit_ppft !='1' ORDER BY a.design_ppft,a.plan_colors_ppft,a.colors_name_ppft ASC";
                                                                ?>  
										...
										?>>
                                                                            <td>
                                                                                <?php
                                                                                echo($row["change_over_ppft"]);
                                                                                ?>
                                                                            </td>
																			
																			<td>
                                                                                <?php
                                                                                echo($row["item01_ppft"]);
                                                                                ?>
                                                                            </td>
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <?php
                                                                                echo($row["pro_no_ppft"]);
                                                                                ?>
                                                                            </td>
                                                                            <td><?php
                                                                                echo($row["design_ppft"]);
                                                                                ?>
                                                                            </td>
                                                                            ...
                                                                            <td>
                                                                                <?php
                                                                                echo($row["imp_plan_ppft"]);
                                                                                ?>

                                                                            </td>
                                                                              <td>
                                                                              <?php
                                                                                echo($pigm->getNumberPigmentMasterByNo($row['design_ppft']));
                                                                                ?>

                                                                            </td>
                                                                            <td>
                                                                                <?php
                                                                                echo($row["plan_colors_ppft"]);
                                                                                ?>
                                                                            </td>
                                                                            <td>
                                                                                <?php
                                                                                echo($row["colors_name_ppft"]);
                                                                                ?>
                                                                            </td>
                                                                    <form method="post" action="">
                                                                        <input type="hidden" id="id" name="id" value="<?php echo($row["id"]) ?>">
                                                                        <td>
                                                                            <input class="form-control" type="text" id="imp_actual_ppft" name="imp_actual_ppft" value="<?php echo($row["colors_name_ppft"]) ?>">
                                                                        </td>
                                                ...
                                                <table class="table table-bordered table-hover" id="tab_logic">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                                $query = "SELECT a.*,b.item01_pm FROM pigment_planner_final_tbl a
LEFT JOIN pigment_master_tbl b
ON a.design_ppft=b.pattern_pm AND a.plan_colors_ppft=b.colours_pm WHERE    a.date_ppft='" . $_GET['date_vpft'] . "' AND a.is_edit_ppft ='1' ORDER BY a.id ASC";
                                                        ?>  
                                                        <?php
                                                        if ($result = $conn->query($query)) {
                                                            $index = 0;
										...
										?>>
                                                                    ...
                                                                    <td>
                                                                        <span class="fa fa-undo" aria-hidden="true" style="cursor:pointer"
                                                                              onclick="unDoEntity('<?php echo($row['id']); ?>', 'pigment_mixing_plan.php?project_no_tct=<?php echo($row['ref_no_ppft']); ?>&machine_no_vpft=<?php echo($row['item01_ppft']); ?>&date_vpft=<?php echo($row['date_ppft']); ?>&id=<?php echo($row['id']); ?>',
                                                                                                      '<?php echo($row['id']); ?>')"
                                                                              ></span
                                                                    </td>
