...
if (isset($_GET['id'])) {
    $cr->deleteColorRrelationships($_GET['id']);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Color Relationships</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Color Relationships
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="color_relationships_view.php"> View

                                </a>
                                <i class="fa fa-angle-right"></i>
                            </li>
                            <li>
                                <a href="#">Color Relationships
                                </a>
                            </li>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Color Relationships
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_crt" id="org_name_pidt"  value="<?php echo($loge_user); ?>" />
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <select id="col_no_crt"   class="form-control"  name="col_no_crt" >
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <select id="col_name_crt"   class="form-control"  name="col_name_crt" >
                                                        ...
                                                        <table class="table table-bordered table-hover" id="tab_logicp">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center" width="15%">Pattern No</th>
                                                                    <th class="text-center" width="20%">Color Index </th>
                                                                    <th class="text-center" width="20%">Color Name </th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr id='addrp0'>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <input  type="text" class="form-control" name='ndesign_no_crt[]' id='ndesign_no_crt[]'  required/>   
                                                                    </td> 
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <select  class="form-control" name='ncol_no_crt[]' id='ncol_no_crt[]' placeholder='Pigment' >
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <select  class="form-control" name='ncol_name_crt[]' id='ncol_name_crt[]' placeholder='Name' class="form-control qty"> 
                                                                            <?php
                                                                            $cr->getColoursName();
                                                                            ?>  
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button type="button" class="btn purple" onClick="return submit_();" > <i class="fa fa-check"></i> save
                                                        </button>
...
<script src="../js/color_relationships.js"></script>
...
<script src="../ajax_post/color_relationships_post.js"></script>

<script src="../js/pattern_list02.js"></script>
