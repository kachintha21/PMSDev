...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Curve Registration Details</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i ></i>Curve Registration Details
                                    </div>
                                    <div class="tools">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'layout_finder_registration.php';">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                       ...
                                       Delete
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM past_curves_details_tbl Where  (org_date_pcdt BETWEEN '2022-01-01' AND '2022-12-31')";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>									
                                                            <?php echo($row["design_pcdt"]); ?> 
                                                        </td>

                                                                   <td>
                                                            <?php echo($row["lot_no_pcdt"]); ?> 
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php echo($row["curves_pcdt"]); ?>
                                                        </td>
                                                        
                                                        
                                                               <td>
                                                            <?php echo($row["qty_pcdt"]); ?>
                                                        </td>
                                                               ...
                                                               <td>
                                                            <?php echo($row["print_date_pcdt"]); ?>
                                                        </td>
                                                         
          
                                                               <td>
                                                            <?php echo($row["first_color_print_pcdt"]); ?>
                                                        </td>
                                                        
                                                        
                                                               <td>
                                                            <?php echo($row["org_name_pcdt"]); ?>
                                                        </td>
                                                        
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'layout_finder_registration.php?id=<?php echo($row['id']); ?>',
                                                                                          '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
