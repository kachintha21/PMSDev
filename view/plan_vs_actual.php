                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                ...
                                <div class="portlet-body form">
                                    <!-- BEGIN FORM-->
                                    <form action="plan_vs_actual.php"  class="form-horizontal form-bordered" id="testform"  method="get">
                                                        ...
                                                        if ($result = $conn->query($query)) {
                                                            ...
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                <tr id='addr0' class="tr-row"  style="background-color: #FAEBD7;">
                                                                  ...
                                                                  onclick="unDoEntity('<?php echo($row['id']); ?>','plan_vs_actual.php?project_no_tct=<?php echo($row['ref_no_vpft']); ?>&machine_no_vpft=<?php echo($row['machine_no_vpft']); ?>&date_vpft=<?php echo($row['date_vpft']); ?>&id=<?php echo($row['id']); ?>',
                                                                  '<?php echo($row['id']); ?>')"
                                                                  ></span
                                                                    ></td>
