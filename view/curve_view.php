...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Curve Master Data</title>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'curve_csv_upload.php';">
                                                        Curve Data Upload  <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                       ...
                                       <div class="form-body">                   
                                            ...
                                            <!-- BEGIN FORM-->
                                            <form action="curve_view.php"  class="form-horizontal form-bordered" id="testform"  method="get">
                                                <div class="form-group form-group">

                                       
                                                    <div class="col-sm-3">                                            
                                                        <select  class="form-control" name="pattern_no_pmt" id="pattern_no_pmt"   onchange="this.form.submit()"> 
                                                             <option value='0'>-  Decal Design -</option>
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                           // $query = "SELECT * FROM curve_master_tbl  order by Id DESC LIMIT 200";
                                            
                                            
                                              if(empty($_GET['pattern_no_pmt'])){
                                                  $query = "SELECT * FROM curve_master_tbl  ORDER BY decal_design_no_cmt DESC limit 0,100";
                                            
                                            }else{
                                                  $query = "SELECT * FROM curve_master_tbl WHERE decal_design_no_cmt='".$_GET['pattern_no_pmt']."'   ";
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo($row["decal_design_no_cmt"]); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo($row["curve_area_cmt"]); ?>
                                                        </td>
                                                        <td>
                                                            <?php echo($row["is_edit_cmt"]); ?>
                                                        </td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            ...
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"
                                                                  ...
                                                                  onclick="window.location.href = 'curve.php';"
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            ...
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"
                                                                  ...
                                                                  onclick="window.location.href = 'curve.php?ID=<?php echo($row["id"]); ?>';"
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'curve.php?id=<?php echo($row['id']); ?>',
                                                                                          '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
...
<script src="../ajax_post/get_curve_master.js"></script>
        <script>
