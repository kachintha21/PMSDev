                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM pigment_preparation_tbl ORDER BY id DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["lot_no_pp"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["colour_index_pp"]); ?> 
                                                        </td>
                                                      
             

                                                        <td>      
                                                            <?php echo($row["pigment_contents_pp"]); ?> 
                                                        </td>  
                                                        ...
                                                        <td>      
                                                            <?php echo($row["org_date_pp"]); ?> 
                                                        </td>  



                                                        <td>      
                                                            <?php echo($row["org_time_pp"]); ?> 
                                                        </td>  
