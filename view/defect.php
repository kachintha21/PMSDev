...
if (isset($_GET['ID'])) {
    $data = $def->getDefectById($_GET['ID']);
}

if (isset($_GET['id'])) {
    $def->deleteDefect($_GET['id']);
...
<html lang="en">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Defect Details
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="defect_view.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> 
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Defect Details
    ...
    <input  type="hidden" class="form-control"  name="id" id="id"        value="<?php
                                        ...
                                        <input  type="hidden" class="form-control"  name="is_edit_dt" id="is_edit_dt" value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[7] + 1);
                                        }
                                                ?>" />
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                <label class="control-label col-sm-2">Defect Name<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-4">

                                                    <input  type="text" class="form-control" name="defect_name_dt"  id="defect_name_dt"  value="<?php
                                                if ($_GET['ID']) {
                                                    echo($data[1]);
                                                }
                                                ?>" />
            ...
            <script src="../ajax_post/defect_post.js"></script>
