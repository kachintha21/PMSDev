                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="pigment_preparation_view.php"> View
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'pigment_preparation_ps.php';">
                                                        Pigment Preparation <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT a.pro_no_ppft as production_no_pst,a.design_ppft as pattern_no_pst,a.lot_ppft as lot_no_pst,a.colors_name_ppft FROM pigment_planner_final_tbl a WHERE a.is_edit_ppft ='0' GROUP BY a.pro_no_ppft   ";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <a href="pigment_preparation.php?pro=<?php echo($row["production_no_pst"])?>">
