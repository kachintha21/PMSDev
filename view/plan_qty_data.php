...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Planned Data</title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="printable_data.php">Planned Data</a>
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'planning_tools.php';">
                                                        Planned Data <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM planed_qty_tbl GROUP BY id ";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo($row["design_name_pqt"]); ?> 
                                                        </td>         

                                                        <td>
                                                            <?php echo($row["curve_pqt"]); ?> 
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php echo($row["org_date_pqt"]); ?>
                                                        </td>


                                                        <td>
                                                            <?php echo($row["org_time_pqt"]); ?>
