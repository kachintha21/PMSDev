...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake| Layout Box </title>
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="btn-group">
                                                        <button  class="btn green" onclick="window.location = 'layout_box_view.php';">
                                                            Layout Box <i class="fa fa-plus"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                    ...
                                                    (a.no_of_sheets_lpt) AS no_of_sheets_pln,cc.imp_plan_vpft,
                                                    ...
                                                    ON a.pro_no_lpt = cc.pro_no_vpft GROUP BY a.pro_no_lpt ORDER BY a.id DESC LIMIT 500";
                                                ?>  
                                                ...
                                                <?php
                                                    if ($result = $conn->query($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="layout_box_curve.php?pro_no=<?php echo($row["pro_no_lpt"]);?>">
