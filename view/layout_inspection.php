...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Layout Inspection</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <h3 class="page-title">Layout Inspection
                        <small></small>
                    </h3>
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="layout_inspection_view.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> <i class="fa fa-circle"></i> </li>

                            <li> <a href="index.php"  style="text-decoration: none" title="Daily_Output" ><b>WIP(<?php echo($li->getWipLayoutInspection($session_pattern_no)); ?>)


                                    </b></a> <i class="fa fa-circle"></i> </li>
                            <li> <a href="index.php"  style="text-decoration: none" title="WIP" ><b>Daily_Output(<?php echo($li->getDailyOutPutQtyLayoutInspection(getServerDate(), $session_pattern_no)); ?>)</b></a> <i class="fa fa-circle"></i> </li>


                            <li> <b>
                                    <a  href="#"   style="text-decoration: none" title="Changed Pattern No"
                                        onClick="return Changed_pattern('',
                                                        'layout_inspection_ps.php',
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Layout Inspection
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_lit" id="org_name_lit"  value="<?php echo($loge_user); ?>" />
                                        ...
                                        <div class="form-body">                  
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" class="form-control" name="pattern_no_lit" id="pattern_no_lit"  value="<?php echo($session_pattern_no); ?>" /></div> 
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <select class="form-control"    name='pro_no_lit' id='pro_no_lit' onchange="return  ajax();" >
                                                        <?php
                                                        $pt->printProductStatusBy($session_pattern_no, 3, "")
                                                        ?>
                                                ...
                                                <div class="col-sm-2">
                                                    <select  class="form-control  col-sm-2" id="lot_no_lit" name="lot_no_lit" onchange="return form_ajax();"  >

                                                    </select>                         
                                                </div>


                                                <div  id="insert_response_ajax"    class="control-label col-sm-2"   >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <select class="form-control select2"   id="judgment_lit" name="judgment_lit" >
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea rows="5" cols="50" class="form-control" name="item01_lit" id="item01_lit">-</textarea>
            ...
            <script src="../ajax_post/json_lit.js"></script>
            <script src="../ajax_post/layout_inspection_post.js"></script>
