                ...
                <tr>
                    <td colspan="3" align="center">
                        ...
                        <table class="y" width="100%" valign="top" >
                            <tr><td>Design No</td> <td>Printing Pattern  </td><td>Curve No</td><td>Qty</td></tr>
                            ...
                            if ($result = $conn->query($query)) {
                                while ($rowt = $result->fetch_assoc()) {
                                    ...
                                    <tr><td>    <?php echo($rowt["design_fdt"]); ?> </td>
                                        ...
                                        <td> 
                                            <?php
                                            echo($rowt["item03_fdt"]);

                                            $date_item = $rowt["item02_fdt"];
                                            ?> </td>

                                        <td>    <?php echo($rowt["curve_fdt"]); ?> </td><td>    <?php echo($rowt["total_fdt"]); ?> </td></tr>
                        ...
                        <table class="y"  width="100%" valign="top" >
                            ...
                            <tr><td style="height:700px" ></td> <td></td><td></td><td></td><td></td></tr>
                        </table>
