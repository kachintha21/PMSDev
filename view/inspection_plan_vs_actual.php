...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Inspection Plan|Actual </title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Decal Inspection Plan|Actual</a>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table  class="table table-striped table-hover table-bordered" id="sample_editable_1" >
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT a.pro_no,a.design,a.lot,a.qtys,b.act_qty,a.p_date FROM (SELECT a.pro_no,a.design,a.p_date,SUM(a.qty) AS qtys,a.lot FROM tbl_cut_ins_planner_wise_data a GROUP BY a.pro_no,a.lot,a.design,a.p_date) a 
LEFT JOIN (SELECT a.pro_no,a.lot,a.design,a.p_date,SUM(a.qty) AS act_qty FROM tbl_cut_ins_plan_ins_data a GROUP BY a.pro_no,a.lot,a.design,a.p_date) b
ON a.pro_no = b.pro_no 
AND a.design = b.design 
AND a.lot = b.lot 
