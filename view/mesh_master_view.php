                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'mesh_master.php';">
                                                        New Mesh <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM mesh_master_tbl ORDER BY id DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["is_edit_mmt"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["org_date_mmt"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["org_time_mmt"]); ?> 
                                                        </td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'mesh_master.php?id=<?php echo($row['id']); ?>',
                                                                                  '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
