                                                    ...
                                                    <div class="col-md-12">
                                                        <table class="table table-bordered table-hover" id="tab_logic">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $query = "SELECT a.*,b.item01_pm FROM virtual_planner_final_tbl a LEFT JOIN pigment_master_tbl b
ON a.design_vpft=b.pattern_pm AND a.plan_colors_vpft=b.colours_pm WHERE     a.machine_no_vpft='" . $_GET['machine_no_vpft'] . "' AND a.date_vpft='" . $_GET['date_vpft'] . "' and a.plan_colors_vpft !='S00'  AND (a.status_vpft ='' ||  a.status_vpft ='0') ORDER BY a.id ASC";
                                                                ?>  
                                            ...
                                            <div class="col-md-12">
                                                <table class="table table-bordered table-hover" id="tab_logic">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $query = "SELECT a.*,b.item01_pm FROM virtual_planner_final_tbl a LEFT JOIN pigment_master_tbl b
ON a.design_vpft=b.pattern_pm AND a.plan_colors_vpft=b.colours_pm WHERE     a.machine_no_vpft='" . $_GET['machine_no_vpft'] . "' AND a.date_vpft='" . $_GET['date_vpft'] . "' and a.plan_colors_vpft !='S00'  AND a.status_vpft ='1'  ORDER BY a.id ASC";
                                                        ?>  
                                                        <?php
                                                        if ($result = $conn->query($query)) {
                                                            $index = 0;
