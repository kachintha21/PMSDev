...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Please update curve master</title>
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" >
                                                        Please update curve master  <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <tbody>
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    $is=$cm->CheckCurveByRefNo($row["dec_patt"],$row["dec_curve"]);
                                                    if($is=="-"){
                                                    ?>    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                            echo("please update the curve master");
                                                            ?>
