...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Decal Inspection  - 2nd</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Decal Inspection - 2nd 
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="dinspection_ps_new.php"  style="text-decoration: none" title="View Data" ><b>View</b></a>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Decal Inspection - 2nd
                                    </div>
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" id="myForm" class="form-horizontal form-bordered" >
                                        ...
                                        <div class="form-body">   
                                            ...
                                            <div class="form-group form-group">
												...
												<label class="control-label col-sm-2">  Total Plan Qty <span style="color: crimson;"> </span></label>
                                                

<div class="col-sm-2">
											<?php
                                            $query = "SELECT a.pro_no,a.design,a.lot,SUM(a.qty) AS qty,a.p_date from tbl_cut_ins_planner_wise_data a 
WHERE a.finalize ='1' and a.pro_no ='" . $session_pattern_no . "' and a.p_date ='" . $p_date . "'
GROUP BY a.pro_no,a.design,a.lot,a.p_date
 ORDER BY a.p_date ";
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
													...
													?>
													 ...
													 <input  type="number" class="form-control" name="rem_qty_qc" id="rem_qty_qc"  value="<?php echo($t_qty); ?>"  readonly/>
...
?>
 ...
 <label class="control-label col-sm-2">Plan Date <span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">


                                                    <input  type="text" class="form-control" name="p_date" id="p_date"  value="<?php echo($p_date); ?> "  readonly/>
											...
											<span style="color: crimson;"> </span></label>
											 ...
											 <div class="form-group form-group">
												...
												<label class="control-label col-sm-2"> 1st Class Sheets </label>
                                                <div class="col-sm-2">


                                                    <input  type="number" class="form-control" name="ins_qty_1st" id="ins_qty_1st"  value=""/>
            ...
            <script src="../ajax_post/dinspection_post_new_2nd.js"></script>
