...
<head>
<meta charset="utf-8"/>
<title>Noritake|Printing Status</title>
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<tbody>
                                                          ...
                                                          <?php
                                                          $query = "SELECT * FROM printing_status_tbl  ORDER BY id DESC";
							...
							<tr>
								...
								<?php echo($row["lot_no_pst"]);?> 
                                                                	...
                                                                	<td>
								<?php echo($row["colour_index_pst"]);?> 
								</td>


								<td>
								<?php echo($row["screen_mesh_pst"]);?> 
								</td>
                                         
                                                              
                                                                	<td>
								<?php echo($row["colour_name_pst"]);?> 
								</td>
                                                              
                                                                	<td>
								<?php echo($row["pro01_pst"]);?> 
								</td>
                                                              
                                                                	<td>
								<?php echo($row["pro02_pst"]);?> 
								</td>
                                                              
                                                       
								<td>
								<?php echo($row["pro03_pst"]);?> 
								</td>
                                      
								<td>
								<?php echo($row["pro04_pst"]);?> 
								</td>
                                                             
                                                              
								<td>
								<?php echo($row["pro05_pst"]);?> 
								</td>    

								                                        
								<td>
								<?php echo($row["pro06_pst"]);?> 
								</td>    

                                             <td>
								<?php echo($row["pro07_pst"]);?> 
								</td>  
