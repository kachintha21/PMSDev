...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Pigment Issue Details</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Pigment Issue Details
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Pigment Issue Details
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                <label class="control-label col-sm-2">Barcode Ref Number<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">
                                                    <input  type="text" class="form-control" name="barcode_ref_no_pidt" id="barcode_ref_no_pidt" 

                                                            value="<?php echo($pl->getNextPigmentIssuesDetailsRefNo("pigment_issues_details_tbl", "NLPLPM")); ?>" 
                                                            />                         
                                                </div>    
                                                ...
                                                <div class="col-sm-2">
                                                    <select  class="form-control" name="design_number_pidt"  id="design_number_pidt" >
...
?>
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" class="form-control" name="weight_pidt" id="weight_pidt"  />                         
                                                </div> 
                                            ...
                                            <div class="form-group form-group">
                                                <label class="control-label col-sm-2">Re-Mixing Date<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">
                                                    <input  type="date" class="form-control" name="re_mixing_date_pidt" id="re_mixing_date_pidt" 
                                                            />                         
                                                </div>   



                                                <label class="control-label col-sm-2">Oil<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">
                                                    <input  type="text" class="form-control" name="oil_oidt" id="oil_oidt" 
                                                            />                         
                                                </div>    
                                                        ...
                                                        <table class="table table-bordered table-hover" id="tab_logicp">
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center" width="15%">Pigment </th>
                                                                    <th class="text-center" width="20%">Content(g)</th>
...
?>  
                                                                        ...
                                                                        <select  class="form-control" name='pigment_pidt[]' id='pigment_pidt[]' placeholder='Pigment' class="form-control qty">
                                                                <?php
                                                                if ($result = $conn->query($query)) {
                                                                    while ($row = $result->fetch_assoc()) {
                                                                        ?>    
                                                                                    ...
                                                                                    <option value="<?php echo($row["pigment_name_ct"]); ?>"><?php echo($row["pigment_name_ct"]); ?> </option>
...
?>
                                                                    ...
                                                                    <td><input type="number" name='content_pidt[]' id='content_pidt[]' placeholder='Content(g)'  type="text"  class="form-control name" /></td>
...
?>
        ...
        <script src="../js/pigment_issues.js"></script>

        <script src="../js/oil_issues.js"></script>



        <script src="../ajax_post/pigment_issues_details_post.js"></script>
