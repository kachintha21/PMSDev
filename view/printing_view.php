...
Date
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM printing_tbl ORDER BY id DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["lot_no_pt"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["colours_index_pt"]); ?> 
                                                        </td>

                                                        <td>

<?php echo($row["machine_no_pt"]); ?> 
</td>
