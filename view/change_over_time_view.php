...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Change Over Time </title>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'change_over_time.php';">
                                        Change Over Time  <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
 ...
 <th>    
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM change_over_time_tbl ORDER BY id DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["machine_no_cott"]); ?> 
                                                        </td>

                                                        
                                                            <td>
                                                            <?php echo($row["time_cott"]); ?> 
                                                        </td>


     
                                                            <td>
                                                            <?php echo($row["is_edit_cott"]); ?> 
                                                        </td>
                                                        ...
                                                        <td>      
                                                            <?php echo($row["org_date_cott"]); ?> 
                                                        </td>                

                                                        <td>      
                                                            <?php echo($row["org_time_cott"]); ?> 
                                                        </td>  
                                                        
                                                                       <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'change_over_time.php';">
                                                           </span>
                                                        </td>

                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-edit" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'change_over_time.php?ID=<?php echo($row["id"]); ?>';" >
                                                           </span>
                                                        </td>
                          ...
                          onclick="deleteEntity('<?php echo($row['id']);?>','change_over_time.php?id=<?php echo($row['id']);?>',
			'<?php echo($row['id']);  ?>')"; 
			 ></span></td>
