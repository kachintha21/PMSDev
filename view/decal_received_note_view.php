...
<head>
<meta charset="utf-8"/>
<title>Noritake|Decal Received Note
</title>
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="row">
									<div class="col-md-6">
										<div class="btn-group">
											<button  class="btn green" onclick="window.location='decal_received_note.php';">
							...
							<tbody>
                                                          ...
                                                          <?php
                                                          $query = "SELECT * FROM decal_received_note_tbl  GROUP BY id DESC";
							...
							<tr>
								...
								<td>
                                                                    <a href="barcode_decal_infor.php?id=<?php echo($row["ref_no_drn"]);?>">
                                                                        
                                                                    
								<?php echo($row["ref_no_drn"]);?> 
                                                                    </a>
								</td>
                                        
								<td>
								<?php echo($row["is_edit_drt"]);?> 
								</td>
							        ...
							        <?php echo($row["remakes_drt"]);?> 
                                                                						...
                                                                						<td>									
							        <?php echo($row["org_date_drt"]);?> 
								</td>
                                                                
                                                                						<td>									
							        <?php echo($row["org_time_drt"]);?> 
								</td>
                                                      
                                                                
                                                                        <td style="width:50px; text-align:center;">
                              <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                          onclick="deleteEntity('<?php echo($row['id']);?>','decal_received_note.php?id=<?php echo($row['ref_no_drn']);?>',
			'<?php echo($row['id']);  ?>')"; 
			 ></span></td>
