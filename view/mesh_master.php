...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Mesh Master </title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Mesh Master
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Mesh Master
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_mmt" id="org_name_mmt"  value="<?php echo($loge_user); ?>" />
                                        ...
                                        <input  type="hidden" class="form-control"  name="is_edit_mmt" id="is_edit_mmt" value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[6] + 1);
                                        }
                                        ?>" />
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                <label class="control-label col-sm-2">Mesh Name<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-3">
                                                    <input  type="text" class="form-control"  name="mesh_name_mmt" id="mesh_name_mmt"   value="<?php
                                                    if ($_GET['ID']) {
                                                        echo($data[2]);
                                                    }
                                                    ?>"  />
...
<?php } ?>
            ...
            <script src="../ajax_post/mesh_master_post.js"></script>
