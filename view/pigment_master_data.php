...
<html lang="en">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'pigment_master.php';">
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <!-- BEGIN FORM-->
                                            <form action="pigment_master_data.php"  class="form-horizontal form-bordered" id="testform"  method="get">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            if(empty($_GET['pattern_no_pmt'])){
                                                  $query = "SELECT * FROM pigment_model_tbl   ORDER BY pattern_no_pmt DESC limit 0,100";
                                            
                                            }else{
                                                  $query = "SELECT * FROM pigment_model_tbl WHERE pattern_no_pmt='".$_GET['pattern_no_pmt']."'  ORDER BY ref_no_pmt DESC ";
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a  href="pigment_data.php?id=<?php echo($row["pattern_no_pmt"]); ?>">
                                                                <?php echo($row["pattern_no_pmt"]); ?> 
                                                            </a>
                                                        </td>
    ...
    <td>
                                                        ...
                                                        <td>
                                                            <?php echo($row["paper_size_pmt"]); ?> 
                                                        </td>



                                                        <td>
                                                            <?php echo($row["stproof_paper_pmt"]); ?> 
                                                        </td>



                                                        <td>
                                                            <?php echo($row["printing_way_pmt"]); ?> 
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php echo($row["market_pmt"]); ?> 
                                                        </td>


                                                        <td>
                                                            <?php echo($row["layout_pmt"]); ?> 
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php echo($row["org_date_pmt"]); ?>
                                                        </td>


                                                        <td>
                                                            <?php echo($row["org_time_pmt"]); ?>
                                                        </td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true" style="cursor:pointer"  onclick="window.location.href = 'pigment_master.php';">
                                                            </span>
                                                        </td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'pigment_master.php?id=<?php echo($row['pattern_no_pmt']); ?>',
                                                                                          '<?php echo($row['pattern_no_pmt']); ?>')"; 
                                                                  ></span></td>
