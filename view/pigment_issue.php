...
if (isset($_GET['id'])) {
    $issue=$pl->gePigmentIssuesById($_GET['id']);
      $pt->deletePigmentTransactionbyByRef($issue[2]);
      $pl->deletePigmentIssuesDetails($_GET['id']);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Pigment Management </title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Pigment Management
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a href="pigment_issue_ps.php">Changed Pattern
                                </a>
                            </li>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Pigment Management
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="design_number_pidt" id="design_number_pidt"  value="<?php echo($pname); ?>"  readonly/> 
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="number" class="form-control" name="weight_pidt" id="weight_pidt"  />                         
                                                </div> 
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="date" class="form-control" name="re_mixing_date_pidt" value=<?php echo(getServerDate());?> id="re_mixing_date_pidt" 
                                                            />                      
                                                </div>   

  <label class="control-label col-sm-2">comments<span style="color: crimson;"> </span></label>
                                                <div class="col-sm-6">
            
                                                       
                                                    
                                                            <textarea rows="3" cols="40" name="remarks_pidt" id="remarks_pidt" ></textarea>
                                                </div>   
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button type="button" class="btn purple" onClick="return submit_();" > <i class="fa fa-check"></i> Print
                                                        </button>
