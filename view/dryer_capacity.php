...
if (isset($_GET['ID'])) {
    $data = $dc->getDryerCapacityById($_GET['ID']);
}

if (isset($_GET['id'])) {
    $dc->deleteDryerCapacity($_GET['id']);
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Dryer Capacity</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Dryer Capacity
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="dryer_capacity_view.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> 
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Dryer Capacity
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="is_edit_dct" id="is_edit_dct" value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[3] + 1);
                                        }
                                                ?>" />
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <?php if ($_GET['ID']) {?>
                                                <input  type="text" class="form-control"  name="machine_no_dct" id="machine_no_dct"        value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[1]);
                                        }
                                                ?>"/>
                                                    ...
                                                    <?php } else {?>
                                                       ...
                                                       <select class="form-control"    name='machine_no_dct' id='machine_no_dct'>
                                                ...
                                                <label class="control-label col-sm-2">Dryer capacity<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">


                                                    <input  type="number" class="form-control"  name="capacity_dct" id="capacity_dct" value="1200" min="1200"       value="<?php
                                        if ($_GET['ID']) {
                                            echo($data[2]);
                                        }
                                                ?>" />
            ...
            <script src="../ajax_post/dryer_capacity_post.js"></script>
