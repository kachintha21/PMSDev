...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Color separation Select</title>
...
?>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Color separation Select
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Color separation Select
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Color separation Select
                                    </div>
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <div class="form-body">            
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    <select  class="form-control" name="pattern_no_sc"  id="pattern_no_sc">
...
<script src="../ajax_post/color_separation_post.js"></script>
