                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="printable_data.php">Print table view</a>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'planning_tools.php';">
                                                        New Planning <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
...
<?php
$query = "SELECT * FROM planning_tbl  ORDER BY org_date_fdt ASC";
?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="printing_plans_new_rprint.php?id=<?php echo($row["ref_no_fdt"]) ?>" >
        ...
        <!--                                                              <td>
            ...
            <a href="printing_plans_new_rprint.php?id=<?php echo($row["ref_no_fdt"]) ?>" >   <?php echo($row["ref_no_fdt"]); ?> </a>
        </td>
                                                        -->
        ...
        <?php echo($row["org_time_fdt"]); ?>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'planning_delete.php?id=<?php echo($row['ref_no_fdt']); ?>',
                                                                                  '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
