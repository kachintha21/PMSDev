...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>NLPL |Daily Screen Plan</title>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        ...
                        $status = $sp->confirmScreenPlannerEntity($_GET['id']);
                        ?>
                    </div>
                    <!-- END PAGE HEADER-->
                    <!-- BEGIN PAGE CONTENT-->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <table style="width:100%">
                                    <tr>
                                        <th rowspan="" > Daily Screen Plan  -<?php echo($vp_data[1]); ?> 
                                        </th>
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    if (($index) % 4 == 0) {
                                                        $color = "#0033FF";
                                                        echo("<label class='strikethrough_text'  style=\"color: $color\"    >");
                                                        $result_ptint = $index / 4;
                                                       // $change_over_spft = $index . "  Topcoat" . $result_ptint;
                                                       // echo($index . "  Topcoat" . $result_ptint);
                                                        $change_over_spft = $index;
                                                        echo($index);
                                                        echo("</label>");
                                                    } else {
...
//                                                    echo($stop_date);
                                        ...
                                        <td>
                                            <?php
                                            echo( $pigm->getNumberPigmentMasterByNo($row['design_vpft']));
                                            ?> 
                                        ...
                                        <td>
                                            <?php
                                            $res = "SELECT * FROM colours_tbl WHERE pattern_no_ct='" . $row['design_vpft'] . "'   AND  colours_code_ct='" . $row['plan_colors_vpft'] . "'   group by  item04_ct ";
                                            if ($resc = $conn->query($res)) {
                                                ...
                                                while ($rowsc = $resc->fetch_assoc()) {
                                                    ...
                                                    if ($rowsc['item04_ct'] == "") {
                                                        ...
                                                        echo($rowsc['item04_ct']);
                                                        $mesh_type_spft = $rowsc['item04_ct'];
                                                    }
                                                }
                                            }
                                            ?>
                                        ...
                                        if ($_GET['ID']) {
                                            $id = 'N/A';
                                            $ID_spft = $row['ID_vpft'];
                                            $ref_no_spft = $row['ref_no_vpft'];
                                            $design_spft = $row['design_vpft'];
                                            $pro_no_spft = $row['pro_no_vpft'];
                                            $lot_spft = $row['lot_vpft'];
                                            $plan_colors_spft = $row['plan_colors_vpft'];
                                            $mesh_type_spft = $mesh_type_spft;
                                            $machine_no_spft = $row['machine_no_vpft'];
                                            $date_spft = $date->format('Y-m-d');
                                            $change_over_spft = $change_over_spft;
                                            $time_spft = $row['time_vpft'];
                                            $shfit_spft = $row['shfit_vpft'];
                                            $start_date_spft = 'N/A';
                                            $finish_date_spft = 'N/A';
                                            $imp_plan_spft = $row['imp_plan_vpft'];
                                            $imp_actual_spft = 0;
                                            $estimate_time_spft = 0;
                                            $remarks_spft = 0;
                                            $is_edit_spft = 0;
                                            $item01_spft = 'N/A';
                                            $item02_spft = 'N/A';
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8 invoice-block">
                        ...
                        <?php
                            ...
                            <a class="btn btn-lg blue hidden-print margin-bottom-5"                   onclick="PlanSaveConfirm('<?php echo($_GET['id']); ?>', 'new_screen_planner.php?id=<?php echo($_GET['id']); ?>&ID=<?php echo ('save'); ?> ',
                                                '<?php echo($_GET['id']); ?>')";  >
                                Save Plan <i class="fa fa-check"></i>
                            </a>
                           <?php } else { ?>
                            <a class="btn btn-lg blue hidden-print margin-bottom-5"                   onclick="PlanResetConfirm('<?php echo($_GET['id']); ?>', 'delete_screen_planner.php?id=<?php echo($_GET['id']); ?>',
                                                '<?php echo($_GET['id']); ?>')";  >
