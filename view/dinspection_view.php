...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake| Decal Inspection  Data </title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Decal Inspection Data </a>
                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'dinspection_ps_defect.php';">
                                                        Decal Inspection Data <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM dinspection_tbl ORDER BY id DESC limit 500";
                                            ?>  
                                            ...
                                            if ($result = $conn->query($query)) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                             ...
                                                             <td>
                                                            <a href="barcode_decal_infor.php?id=<?php echo($row["item02_dt"]);?>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["printing_pattern_dt"]); ?> 
                                                        </td>
                            ...
                            <td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'delete_dinspection.php?id=<?php echo($row['id']); ?>',
                                                                                  '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
