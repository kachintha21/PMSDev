...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake |Layout Finder</title>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content ">
        ...
        <div class="page-container">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Layout Finder
                                </a>
                            </li>
                             <i class="fa fa-angle-right"></i>
                             
                                  <li>
                                      <a href="layout_finder_registration.php" target="new">Master Data
                                </a>
                            </li>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Layout Finder </div>
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_pt" id="org_name_pt"  value="<?php echo($loge_user); ?>" />
                                        ...
                                        <div class="form-body">                    
                                            ...
                                            <div class="form-group form-group-sm">
                                                ...
                                                <div class="col-sm-2">
                                                    <input  type="text" class="form-control" name="design_pt" id="design_pt"    placeholder="Design No" onkeyup="return submit_();" id="process_name_pt" 
                                                            />                         
                                                </div>                                                        
                                            ...
                                            <div class="form-group form-group-sm">
                                                <div class="col-sm-2">
                                                    <input  type="text" class="form-control" name="curve01" id="curve01"    placeholder="Curve-01" onkeyup="return submit_();" id="process_name_pt" 
                                                            /> 
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="curve02" id="curve02"    placeholder="Curve-02" onkeyup="return submit_();" id="process_name_pt" 
                                                            /> 
                                                </div>
                                                <div class="col-sm-2">


                                                    <input  type="text" class="form-control" name="curve03" id="curve03"    placeholder="Curve-03" onkeyup="return submit_();" id="process_name_pt" 
                                                            />    
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="curve04" id="curve04"    placeholder="Curve-04" onkeyup="return submit_();" id="process_name_pt" 
                                                            />    
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="curve05" id="curve05"    placeholder="Curve-05" onkeyup="return submit_();" id="process_name_pt" 
                                                            />    
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="curve06" id="curve06"    placeholder="Curve-06" onkeyup="return submit_();" id="process_name_pt" 
                                                            />    
            ...
            <div class="form-group form-group-sm">
                                                <div class="col-sm-2">
                                                    <input  type="text" class="form-control" name="curve07" id="curve07"    placeholder="Curve-07" onkeyup="return submit_();" id="process_name_pt" 
                                                            /> 
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="curve08" id="curve08"    placeholder="Curve-08" onkeyup="return submit_();" id="process_name_pt" 
                                                            /> 
                                                </div>
                                                <div class="col-sm-2">


                                                    <input  type="text" class="form-control" name="curve09" id="curve09"    placeholder="Curve-09" onkeyup="return submit_();" id="process_name_pt" 
                                                            />    
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="curve10" id="curve10"    placeholder="Curve-10" onkeyup="return submit_();" id="process_name_pt" 
                                                            />    
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="curve11" id="curve11"    placeholder="Curve-11" onkeyup="return submit_();" id="process_name_pt" 
                                                            />    
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="curve12" id="curve12"    placeholder="Curve-12" onkeyup="return submit_();" id="process_name_pt" 
                                                            />    
...
<script src="../ajax_post/search_post.js"></script>
