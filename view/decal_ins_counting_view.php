...
<html lang="en">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'decal_ins_counting.php';">
                                                        Decal Ins Counting <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
  ...
  <th>    
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM decal_ins_counting_tbl ORDER BY id DESC limit 50";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["ins_no_1"]); ?> 
                                                        </td>
														 <td>

                                                            <?php echo($row["ins_no_2"]); ?> 
                                                        </td>
														 <td>

                                                            <?php echo($row["ins_no_3"]); ?> 
                                                        </td>
														 <td>

                                                            <?php echo($row["ins_no_4"]); ?> 
                                                        </td>
														 <td>

                                                            <?php echo($row["ins_no_5"]); ?> 
                                                        </td>
														 <td>

                                                            <?php echo($row["ins_no_6"]); ?> 
                                                        </td>
                                                        ...
                                                        <td style="width:50px; text-align:center;">
                                                            <span class="glyphicon glyphicon-remove" aria-hidden="true" style="cursor:pointer"
                                                                  onclick="deleteEntity('<?php echo($row['id']); ?>', 'decal_ins_counting.php?id=<?php echo($row['id']); ?>',
                                                                                          '<?php echo($row['id']); ?>')"; 
                                                                  ></span></td>
