...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Add additional Curve  
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title"> Add additional Curve  
                        <small></small>
                    </h3>
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="planning_data.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> <i class="fa fa-circle"></i> 
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Add additional Curve 
                                               ...
                                               <table class="table table-bordered table-hover" >
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="text-center" width="8%">Curve No</th>
                                                                    <th class="text-center" width="10%">Decal Pattern</th>
...
<?php
   ...
   $query = "SELECT * FROM planning_tbl  WHERE ref_no_fdt='" . $_GET['id'] . "'  ORDER BY total_fdt ASC   ";
    
       
                            if ($result = $conn->query($query)) {
                                while ($rowt = $result->fetch_assoc()) {
                                    $DecalNumber=$rowt["design_fdt"];
                                      $item02_fdt=$rowt["item02_fdt"];
                                       $item05_fdt=$rowt["item05_fdt"];
                                    ?> 
                                    ...
                                    <tr><td>    <?php echo($rowt["design_fdt"]); ?> </td>
                                        ...
                                        <td> 
                                            <?php
                                            echo($cm->getDecalNumberByRefNo($rowt["design_fdt"], $rowt["curve_fdt"]));

                                            $date_item = $rowt["item02_fdt"];
                                            ?> </td>
                                        

                                        <td>    <?php echo($rowt["total_fdt"]); ?> </td></tr>
 <?php
                                }
                            }
                            ?>
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea rows="5" cols="40" name="item04_fdt" id="item04_fdt" >-</textarea>
                                        ...
                                        <input  type="hidden" class="form-control" name="ref_no_fdt" id="ref_no_fdt"    value="<?php echo($_GET['id']);?>"/>
 <input  type="hidden" class="form-control" name="item02_fdt" id="item02_fdt"    value="<?php echo($item02_fdt);?>"/>
 <input  type="hidden" class="form-control" name="item05_fdt" id="item05_fdt"    value="<?php echo($item05_fdt);?>"/>
...
<?php ?>
                                                                <tr id='addrp0'>
                                                                    <td>1</td>
                                                                    <td>
                                                                        <input type="text" name='design_fdt[]' id='design_fdt[]' placeholder='Design'  type="text"  class="form-control" value="<?php echo($DecalNumber); ?>"  readonly/>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <?php
                                                                        $query = "SELECT curve_no_cmt,decal_design_no_cmt FROM curve_master_tbl WHERE  fg_design_no_cmt='" . $DecalNumber . "' ";
                                                                        ?>


                                                                        <select name="curve_fdt[]" id="curve_fdt[]" class="form-control product">
                                                                            <option value="">-Select-</option>
                                                                            <?php
                                                                            if ($result = $conn->query($query)) {
                                                                                while ($row = $result->fetch_assoc()) {
                                                                                    ?>  
                                                                                    <option data-price="<?php echo $row['decal_design_no_cmt']; ?>"  data-name="<?php echo $row['curve_no_cmt']; ?>"    value="<?php echo $row['curve_no_cmt'] ?>">
                                                                    ...
                                                                    <td><input type=text name='item03_fdt[]' id='item03_fdt[]'  class="form-control price" /></td>



                                                                    <td><input type="number" name='total_fdt[]' id='total_fdt[]'      type="text"  class="form-control qty" /></td>
                                                ...
                                                <div class="form-actions">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            ...
                                                            <button type="button" class="btn default"  onclick="location.href='printing_plans_new_rprint.php?id=<?php echo($_GET['id'])?>'">Cancel</button>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <script src="../ajax_post/curve_registration_post.js"></script>
