...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Inspection Data</title>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT a.pro_no,a.design,a.lot,SUM(a.qty) AS qty,a.p_date from tbl_cut_ins_planner_wise_data a WHERE a.finalize ='1' and a.ins_complete ='0'
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <a href="dinspection_new.php?pro=<?php echo($row["pro_no"])?>&p_date=<?php echo($row["p_date"])?>">
        <?php echo($row["pro_no"]); ?> 
