                                        ...
                                        <div class="form-body">                 
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    ?>
                                                    <select  class="form-control" name="project_no_tct" id="project_no_tct" > 
...
?>
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <select  class="form-control" name="machine_no_vpft" id="machine_no_vpft" > 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody>
        ...
        <tr>
          ...
          <td>
            <input name="lo_time" type="text" id="lo_time" size="5" readonly>
          </td>
          <td>
