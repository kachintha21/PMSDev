...
<head>
<meta charset="utf-8"/>
<title>Noritake|Product Table</title>
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<tbody>
                                                          ...
                                                          <?php
                                                          $query = "SELECT * FROM product_status_tbl  ORDER BY pattern_no_pt DESC";
							...
							<tr>
								...
								<td>
								<?php echo($row["pro01_pt"]);?> 
								</td>
                                                              
                                                         
                                                                	<td>
								<?php echo($row["pro02_pt"]);?> 
								</td>
                                                              
                                                                	<td>
								<?php echo($row["pro03_pt"]);?> 
								</td>
                                                              
                                                                	<td>
								<?php echo($row["pro04_pt"]);?> 
								</td>
                                                              
                                                                	<td>
								<?php echo($row["pro05_pt"]);?> 
								</td>
                                                              
                                                                	<td>
								<?php echo($row["pro06_pt"]);?> 
								</td>
