...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Film Outing</title>
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'film_outing.php';">
                                                        Film Outing<i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
...
Date
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT * FROM film_outing_tbl ORDER BY id DESC";
                                            ?>  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php echo($row["lot_fot"]); ?> 
                                                        </td>


                                                        <td>

                                                            <?php echo($row["sheets_fot"]); ?> 
                                                        </td>
                                                      

                                                        <td>

                                                            <?php echo($row["judgment_fot"]); ?> 
                                                        </td>
    
                                                        <td>      
                                                            <?php echo($row["org_date_fot"]); ?> 
                                                        </td>                

                                                        <td>      
                                                            <?php echo($row["org_time_fot"]); ?> 
                                                        </td>  
