...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Noritake|Layout Film outing</title>
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Layout Film outing
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li> <a href="film_outing_view.php"  style="text-decoration: none" title="View Data" ><b>View</b></a> <i class="fa fa-circle"></i> </li>

                      


                            <li> <a href="#"  style="text-decoration: none" title="WIP" ><b>WIP(<?php echo($fo->getWipFilmOuting()); ?>)</b></a>                       <i class="fa fa-angle-right"></i> </li>





                            <li> <a href="#"  style="text-decoration: none" title="Daily_Output" ><b>Daily_Output(<?php echo($fo->getDailyOutPutQtyFilmOuting(getServerDate())); ?>)</b></a>
                        ...
                        <div class="col-md-12"> 
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption"> <i class="fa fa-gift"></i>Layout Film outing
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form action="#" name="frmPurchaseRequestAddEdit" class="form-horizontal form-bordered" id="myForm" >
                                        ...
                                        <input  type="hidden" class="form-control"  name="org_name_fot" id="org_name_fot"  value="<?php echo($loge_user); ?>" />
                                        ...
                                        <div class="form-body">                   
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="pattern_no_fot" id="pattern_no_fot"  value="<?php echo($preparing[4]); ?>" />
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="pro_no_fot" id="pro_no_fot"  value="<?php echo($session_pattern_no); ?>" />
                                                ...
                                                <div class="col-sm-2">
                                                    ...
                                                    <input  type="text" class="form-control" name="lot_fot" id="lot_fot"  value="<?php echo($preparing[3]); ?>" />
                                            ...
                                            <div class="form-group form-group">
                                                <label class="control-label col-sm-2">Film Out Date<span style="color: crimson;"> *</span></label>
                                                <div class="col-sm-2">




                                                    <input  type="date" class="form-control" name="sheets_fot" id="sheets_fot"  />
                                                ...
                                                <div class="col-md-2">
                                                    <select class="form-control select2"   id="judgment_fot" name="judgment_fot" >
                                            ...
                                            <div class="form-group form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea rows="5" cols="50" class="form-control" name="item01_fot" id="item01_fot">-</textarea>
            ...
            <script src="../ajax_post/film_outing_post.js
            "></script>
