                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="screen_making_view.php"> View
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <button  class="btn green" onclick="window.location = 'screen_making_ps.php';">
                                                        Screen Making <i class="fa fa-plus"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $query = "SELECT pro_no_spft as production_no_pst,a.design_spft as pattern_no_pst,a.lot_spft as lot_no_pst,a.plan_colors_spft as colors_name_ppft  FROM screen_planner_final_tbl a 
WHERE  a.plan_colors_spft !='S00'  and a.is_edit_spft !='1'  
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <a href="screen_making.php?pro=<?php echo($row["production_no_pst"])?>">
