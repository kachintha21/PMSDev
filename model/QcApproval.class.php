...
class QcApproval{
	...
	public function deleteProcess($id) {
		//print("DELETE FROM qc_approval_tbl WHERE id='" . $id . "' ");exit;
        $query = "DELETE FROM qc_approval_tbl WHERE id='" . $id . "' ";
    ...
    public function getQcApprovalByNo($id) {
        $la = array();
        $query = "SELECT*FROM qc_approval_tbl WHERE pro_no_qc='" . $id . "'  ";
        $result = $this->mysqli->query($query);
    ...
    public function getDailyOutPutQtyQcApproval($date) {
        $query = "SELECT org_date_qc FROM qc_approval_tbl WHERE org_date_qc='" . $date . "'  GROUP BY  lot_no_qc   ";
        $result = $this->mysqli->query($query);
        $num_result = $result->num_rows;
        if ($num_result > 0) {
            return $num_result;
    ...
    public function createNewQcApproval(
        ...
        $res = "INSERT INTO qc_approval_tbl  SET
        id='".$id."',
        pro_no_qc='".$pro_no_qc."',
    ...
    public function updateQcApproval(
        ...
        $res = "UPDATE qc_approval_tbl SET
        pro_no_qc='".$pro_no_qc."',
        pattern_no_qc='".$pattern_no_qc."',
        lot_no_qc='".$lot_no_qc."',
        printing_qty_qc='".$printing_qty_qc."',
