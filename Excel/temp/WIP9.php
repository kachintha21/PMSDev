 ...
 if(isset($_POST['filter']))
  {
		  ...
		  if($_POST['stage']!=NULL) {   $where.=" AND belt='".$_POST['stage']."'"; }
		  ...
		  {
			   if($_POST['process']=='Filtered')
			   {
				   
				   $where.=" AND last_record='1'";	 
...
<select name="belt" id="belt">
  ...
  <select name="stage" id="stage">
   <option></option>
	...
	{
	?>
    <option value="<?php print  $_POST['stage'];?>" selected="selected">
      <?php  print $_POST['stage'];?>
    </option>
    <?php
	}
	?>
...
<div class="CSSTableGenerator" align="center" >
  <table width="1102" height="82" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
 ...
 <td width="59">Date</td>
	...
	if(isset($_POST['filter']))
	{
	 ...
	 $sql =mysql_query("SELECT * FROM cm  INNER JOIN daily_plan  ON cm.pjt_no = daily_plan.pjtno AND design=pattern AND item=itemno WHERE $where AND belt !='D' AND plan_status='0'   ORDER BY cm.id,design, item,chit_no  ")or die ("err1");
