 ...
 if(isset($_POST['filter']))
  {
		  ...
		  if($_POST['belt']!=NULL) { $where.=" AND bbelt='".$_POST['belt']."'";  }
...
<div class="CSSTableGenerator" align="center" >
 ...
 <td width="59">Date</td>
      ...
      <td width="61">Act. Qty</td>
        ...
        <td width="58">Pri.</td>
        <td width="81">Shipment</td>
        <td width="73">Ship Date</td>
	...
	if(isset($_POST['filter']))
	{
	   $sql =mysql_query("SELECT * FROM cm  INNER JOIN daily_plan  ON cm.pjt_no = daily_plan.pjtno AND design=pattern AND item=itemno WHERE $where ORDER BY design, item,chit_no, cm.id")or die ("err"); 
	 }
 ...
 ?>
   <tr onMouseOver="style.backgroundColor='#84DFC1'"  onmouseout="style.backgroundColor=''" >
      ...
      <td nowrap="nowrap"><?php print $r4['bbelt']."&nbsp;"; ?></td>
      <td><?php print $r4['distant']."&nbsp;"; ?></td>
      ...
      <td><?php print $r4['qty']-$r4['pro_qty'] ."&nbsp;"; ?></td>
      <td><?php print $r4['remarks']."&nbsp;"; ?></td>
      <td><?php print $r4['priority']."&nbsp;"; ?></td>
      <td><?php print $r4['shipment']."&nbsp;"; ?></td>
      <td><?php print $r4['ship_date']."&nbsp;"; ?></td>
    </tr>
