 ...
 if(isset($_POST['filter']))
  {
		 ...
		 if($_POST['stage']!=NULL) {   $where.=" AND stage='".$_POST['stage']."'"; }
		  ...
		  else if($_POST['process']=="4"){ $process="Dec"; $current_stage="4"; }
		  else if($_POST['process']=="4F"){	$process="Firing"; $current_stage="4"; }
		  else if($_POST['process']=="5"){ $process="Dec"; $current_stage="5"; }
		  else if($_POST['process']=="5F"){	$process="Firing"; $current_stage="5"; }
 	  ...
 	  if($_POST['belt']!=NULL) { 
			 ...
			 if($_POST['process']=="2")
			 {
				 $where.=" AND bbelt NOT LIKE '%T%' AND bbelt!='E1'";
			 ...
			 $where.=" AND bbelt LIKE '%T%'";    }
			  ...
			  else if($_POST['belt']=="W/O T1-T4") { 
			 
			 $where.=" AND !(bbelt ='T1' OR  bbelt ='T2' OR  bbelt ='T3' OR  bbelt ='T4') AND bbelt LIKE '%T%'";   
			 
			  }
			  else if($_POST['belt']=="WITH T1-T4") { 
...
<select name="belt" id="belt">
   <option value="">All</option>
     ...
     <option value="W/O T1-T4">W/O T1-T4</option>
     <option value="WITH T1-T4">WITH T1-T4</option>
...
<select name="stage" id="stage">
  <option></option>
  <option value="F">FW1</option>
  <option value="H">HW1</option>
...
<center> <font face="Lucida Sans Unicode, Lucida Grande, sans-serif" size="6px"><u> Daily Actual : 
      <?php
...
<div class="CSSTableGenerator" align="center" >
  <table width="638" height="82" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
 
 <td width="59">Date</td>
      <td width="51">PJT No</td>
	...
	if(isset($_POST['filter']))
	{
	    ...
	    $sql =mysql_query("SELECT * FROM cm   WHERE $where  ORDER BY cm.id,design, item,chit_no  ")or die ("err");
 ...
 ?>
   <tr onMouseOver="style.backgroundColor='#84DFC1'"  onmouseout="style.backgroundColor=''" >
      <td><?php print $r4['fdate']; ?></td>
      <td><?php print $r4['pjt_no']; ?></td>
